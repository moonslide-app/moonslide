...
var e = {
        ...
        init: function (e) {
            e.getRevealElement().addEventListener('mousedown', function (n) {
                ...
                n[i] && !e.isOverview() && (n.preventDefault(), t.to({ x: n.clientX, y: n.clientY, scale: d, pan: !1 }))
            })
        },
        destroy: function () {
            t.reset()
    ...
    t = (function () {
        ...
        function s(t, n) {
            ...
            if (
                ...
                if (1 === n) document.body.style.transform = ''
                    ...
                    ;(document.body.style.transformOrigin = i), (document.body.style.transform = d)
                }
            else
                1 === n
        ...
        function c() {
            ...
            o < i
                ...
                : o > window.innerHeight - i && window.scroll(d.x, d.y + (1 - (window.innerHeight - o) / i) * (14 / e)),
                n < t
                    ? window.scroll(d.x - (14 / e) * (1 - n / t), d.y)
                    : n > window.innerWidth - t &&
                      window.scroll(d.x + (1 - (window.innerWidth - n) / t) * (14 / e), d.y)
        }
        function r() {
            return {
                ...
                to: function (n) {
                    if (1 !== e) t.out()
                        ...
                        void 0 !== n.width &&
                            void 0 !== n.height &&
                            (n.scale = Math.max(
                                Math.min(window.innerWidth / n.width, window.innerHeight / n.height),
                                1
                            )),
                            n.scale > 1 &&
                                ((n.x *= n.scale),
