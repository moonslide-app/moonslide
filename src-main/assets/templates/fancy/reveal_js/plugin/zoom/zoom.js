     ...
     */ var e = {
            ...
            init: function (e) {
                e.getRevealElement().addEventListener('mousedown', function (o) {
                    ...
                    o[i] &&
                        !e.isOverview() &&
                        (o.preventDefault(), t.to({ x: o.clientX, y: o.clientY, scale: d, pan: !1 }))
                })
            },
            destroy: function () {
                t.reset()
                ...
                n < i
                    ...
                    o < t
                        ...
                        : o > window.innerWidth - t &&
                          window.scroll(d.x + (1 - (window.innerWidth - o) / t) * (14 / e), d.y)
            }
            function r() {
                return {
                    ...
                    to: function (o) {
                        if (1 !== e) t.out()
                            ...
                            void 0 !== o.width &&
                                void 0 !== o.height &&
                                (o.scale = Math.max(
                                    Math.min(window.innerWidth / o.width, window.innerHeight / o.height),
                                    1
                                )),
                                o.scale > 1 &&
                                    ((o.x *= o.scale),
