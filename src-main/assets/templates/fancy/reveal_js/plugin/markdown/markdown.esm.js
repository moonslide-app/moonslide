...
var xe,
    ...
    we = Math.random(),
    Be = function (e) {
        return 'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++Ce + we).toString(36)
    },
    Se = ke.exports,
    _e = Be,
    Te = Se('keys'),
...
var Qe = {
        ...
        getterFor: function (e) {
            return function (t) {
                var n
                if (!je(t) || (n = Fe(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
                return n
            }
        },
    },
...
;(le.exports = function (e, t, n, r) {
    ...
    'function' == typeof n &&
        ...
        e !== Ve ? (i ? !a && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : Ye(e, t, n)) : o ? (e[t] = n) : Xe(t, n)
...
xn
    ...
    : mn && (!(vn = mn.match(/Edge\/(\d+)/)) || vn[1] >= 74) && (vn = mn.match(/Chrome\/(\d+)/)) && (yn = vn[1])
var Fn = yn && +yn,
    bn = Fn,
    Cn = D,
    wn =
    ...
    Xn = function (e, t, n, r) {
        ...
        if (!i || !o || ('replace' === e && (!Hn || !Qn || Yn)) || ('split' === e && !Kn)) {
            var a = /./[u],
                s = n(
                    u,
                    ''[e],
                    ...
                    { REPLACE_KEEPS_$0: Qn, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Yn }
                ),
                l = s[0],
                c = s[1]
    ...
    fr = function (e, t) {
        ...
        if ('RegExp' !== lr(e)) throw TypeError('RegExp#exec called on incompatible receiver')
        return cr.call(e, t)
    },
    pr = Xn,
    hr = ee,
    ...
    return [
        ...
        function (e, r) {
            ...
            for (var g, d = '', v = 0, y = 0; y < h.length; y++) {
                D = h[y]
                for (var A = String(D[0]), m = mr(kr(gr(D.index), l.length), 0), k = [], E = 1; E < D.length; E++)
...
var Er = _,
    xr = ee,
    Fr = function (e) {
        if (!Er(e) && null !== e) throw TypeError("Can't set " + String(e) + ' as a prototype')
        return e
    },
    br =
...
if (
    ...
    Lr(
        ...
        !tu ||
            nu ||
            Qr(function () {
                return (eu[Kr] = !1), Xr(Jr) != Jr || Xr(eu) == eu || '/a/i' != Xr(Jr, 'i')
            })
    )
) {
    for (
            ...
            (r =
                ...
                ''.split(/.?/).length
                    ? function (e, n) {
                          ...
                          return (
                              c === r.length ? (!a && f.test('')) || s.push('') : s.push(r.slice(c)),
            ...
            [
                ...
                function (e, u) {
                    ...
                    for (var h = 0, D = 0, g = []; D < a.length; ) {
                        ...
                        if (null === v || (d = Vu(qu(f.lastIndex + (Hu ? D : 0)), a.length)) === h) D = Uu(a, D, l)
                        else {
                            if ((g.push(a.slice(h, D)), g.length === p)) return g
                            for (var y = 1; y <= v.length - 1; y++) if ((g.push(v[y]), g.length === p)) return g
                            D = h = d
                        }
                    }
...
var Yu = C,
    ...
    Ju = function (e) {
        return function (t) {
            var n = String(Yu(t))
            return 1 & e && (n = n.replace(Xu, '')), 2 & e && (n = n.replace(Wu, '')), n
        }
    },
...
var ii = {
    ...
    hi = function (e, t) {
        ...
        return (
                ...
                ('function' != typeof (n = e.constructor) || (n !== Array && !fi(n.prototype))
...
var Ui = p.Promise,
    ...
    Hi = Pn('toStringTag'),
    Qi = function (e, t, n) {
        e && !Gi((e = n ? e : e.prototype), Hi) && Zi(e, Hi, { configurable: !0, value: t })
    },
    Vi = {},
    Yi = Vi,
    Ki = Pn('iterator'),
...
;(Bo && So) ||
    ...
    Co
        ...
        : To && !bo
        ? ((go = (Do = new To()).port2), (Do.port1.onmessage = $o), (ho = Eo(go.postMessage, go, 1)))
        : mo.addEventListener &&
...
var fa,
    ...
    Ra = function (e, t, n) {
        var r,
            ...
            d = function (e) {
                return f ? (no(e), h ? D(e[0], e[1], g) : D(e[0], e[1])) : h ? D(e, g) : D(e)
            }
        if (p) r = e
        else {
            if ('function' != typeof (u = oo(e))) throw TypeError('Target is not iterable')
            if (ro(u)) {
                for (i = 0, o = uo(e.length); o > i; i++) if ((a = d(e[i])) && a instanceof so) return a
                return new so(!1)
            }
            r = u.call(e)
        }
    ...
    ls = qa(Va, function () {
        ...
        return ((t.constructor = {})[Qa] = n), !(ss = t.then(function () {}) instanceof n) || (!e && Za && !as)
    }),
    cs =
        ls ||
        !Ia(function (e) {
                    ...
                    try {
                        c
                            ? (u || (2 === e.rejection && ds(e), (e.rejection = 1)),
                              !0 === c ? (o = r) : (h && h.enter(), (o = c(r)), h && (h.exit(), (s = !0))),
                              o === l.promise ? p(ts('Promise-chain cycle')) : (a = fs(o)) ? a.call(o, f, p) : f(o))
                            : p(r)
                    } catch (e) {
                        h && !s && h.exit(), p(e)
                    }
    ...
    hs = function (e, t, n) {
        var r, u
        os
            ? (((r = ns.createEvent('Event')).promise = t), (r.reason = n), r.initEvent(e, !1, !0), ka.dispatchEvent(r))
            : (r = { promise: t, reason: n }),
            !as && (u = ka['on' + e]) ? u(r) : 'unhandledrejection' === e && La('Unhandled promise rejection', n)
    },
    Ds = function (e) {
        za.call(ka, function () {
            var t,
            ...
            if (
                gs(e) &&
                ((t = Na(function () {
                    Ga ? rs.emit('unhandledRejection', r, n) : hs('unhandledrejection', n, r)
                })),
    ...
    ys = function (e, t, n) {
        e.done || ((e.done = !0), n && (e = n), (e.value = t), (e.state = 2), ps(e, !0))
    },
    As = function (e, t, n) {
        if (!e.done) {
            ;(e.done = !0), n && (e = n)
...
Bs(
    { target: 'Array', proto: !0, forced: !zs },
    {
        slice: function (e, t) {
            ...
            if (
                _s(i) &&
                ('function' != typeof (n = i.constructor) || (n !== Array && !_s(n.prototype))
                    ? Ss(n) && null === (n = n[$s]) && (n = void 0)
                    : (n = void 0),
                n === Array || void 0 === n)
            )
                return Ps.call(i, a, s)
            for (r = new (void 0 === n ? Array : n)(Ls(s - a, 0)), u = 0; a < s; a++, u++) a in i && Is(r, u, i[a])
            return (r.length = u), r
        },
    }
)
var Ms,
    ...
    Qs = g
        ...
        : function (e, t) {
              Gs(e)
              for (var n, r = Hs(t), u = r.length, i = 0; u > i; ) Zs.f(e, (n = r[i++]), t[n])
              return e
          },
    Vs = ee,
    Ys = Qs,
...
var ul =
        ...
        function (e, t) {
            var n
            return (
                null !== e ? ((tl.prototype = Vs(e)), (n = new tl()), (tl.prototype = null), (n[el] = e)) : (n = rl()),
                void 0 === t ? n : Ys(n, t)
            )
        },
    il = ul,
...
var ll,
    ...
    Fl = Pn('iterator'),
    bl = !1
;[].keys && ('next' in (fl = [].keys()) ? (cl = kl(kl(fl))) !== Object.prototype && (ll = cl) : (bl = !0)),
    (null == ll ||
        ml(function () {
            var e = {}
...
var Cl = { IteratorPrototype: ll, BUGGY_SAFARI_ITERATORS: bl },
    ...
    Il = function (e, t, n) {
        var r = t + ' Iterator'
        return (e.prototype = Bl(wl, { next: Sl(1, n) })), _l(e, r, !1), (Tl[r] = Ol), e
    },
    jl = Al,
    zl = br,
    $l = Qi,
    ...
    Gl = function (e, t, n, r, u, i, o) {
        ...
        if (
            (d &&
                ...
                Nl !== Object.prototype &&
                    a.next &&
                    (jl(a) !== Nl && (zl ? zl(a, Nl) : 'function' != typeof a[ql] && Pl(a, ql, Zl)), $l(a, f, !0))),
            'values' == u &&
                D &&
                'values' !== D.name &&
                ((p = !0),
            ...
            if (((s = { values: c('values'), keys: i ? g : c('keys'), entries: c('entries') }), o))
        ...
        concat: function (e) {
            ...
            for (t = -1, r = arguments.length; t < r; t++)
                if (_c((i = -1 === t ? o : arguments[t]))) {
                    if (s + (u = Ec(i.length)) > 9007199254740991) throw TypeError('Maximum allowed index exceeded')
...
Tc(
    { target: 'Array', proto: !0, forced: !Pc },
    {
        splice: function (e, t) {
            ...
            if (((u.length = r), n < r)) {
                for (i = c; i < l - r; i++) (a = i + n), (o = i + r) in s ? (s[a] = s[o]) : delete s[a]
                for (i = l; i > l - r + n; i--) delete s[i - 1]
            } else if (n > r)
                for (i = l - r; i > c; i--) (a = i + n - 1), (o = i + r - 1) in s ? (s[a] = s[o]) : delete s[a]
...
var Uc = en,
    ...
    Gc = Zc
        ...
        : ''.trimStart
Uc({ target: 'String', proto: !0, forced: Zc }, { trimStart: Gc, trimLeft: Gc })
var Hc =
        Object.is ||
        function (e, t) {
...
var nf = C,
    ...
    of = function (e, t, n, r) {
        var u = String(nf(e)),
            i = '<' + t
        return '' !== n && (i += ' ' + n + '="' + String(r).replace(rf, '&quot;') + '"'), i + '>' + u + '</' + t + '>'
    }
en(
    {
        target: 'String',
...
en(
    ...
    {
        includes: function (e) {
            return !!~String(Df(this)).indexOf(hf(e), arguments.length > 1 ? arguments[1] : void 0)
        },
    }
)
var df = {
...
function _f(e, t, n) {
    ...
    t &&
        !Sf.test(n) &&
        (n = (function (e, t) {
            Tf[' ' + e] || (Of.test(e) ? (Tf[' ' + e] = e + '/') : (Tf[' ' + e] = Pf(e, '/', !0)))
...
function Nf(e, t, n, r) {
    ...
    if ('!' !== e[0].charAt(0)) {
        r.state.inLink = !0
        var a = { type: 'link', raw: n, href: u, title: i, text: o, tokens: r.inlineTokens(o, []) }
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        if (t) {
                            ...
                            var u = { type: 'heading', raw: t[0], depth: t[1].length, text: n, tokens: [] }
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        if (t) {
                            ...
                            for (
                                var y = new RegExp('^( {0,3}'.concat(g, ')((?: [^\\n]*)?(?:\\n|$))'));
                                e && ((D = !1), (t = y.exec(e))) && !this.rules.block.hr.test(e);
                                ...
                                if (
                                    ...
                                    !c &&
                                        /^ *$/.test(f) &&
                                        ((n += f + '\n'), (e = e.substring(f.length + 1)), (D = !0)),
                                    !D)
                                )
                                    for (
                                        var A = new RegExp(
                                            '^ {0,'.concat(Math.min(3, i - 1), '}(?:[*+-]|\\d{1,9}[.)])')
                                        );
                                        e &&
                                        ((c = p = e.split('\n', 1)[0]),
                            ...
                            for (o = 0; o < m; o++) {
                                ...
                                !v.loose && k.length && E && ((v.loose = !0), (v.items[o].loose = !0))
                            }
                            return v
                        }
                    },
                        ...
                        if (t) {
                            ...
                            return (
                                this.options.sanitize &&
                                    ((n.type = 'paragraph'),
                                    (n.text = this.options.sanitizer ? this.options.sanitizer(t[0]) : xf(t[0])),
                                    (n.tokens = []),
                        ...
                        if (t) {
                            ...
                            if (n.header.length === n.align.length) {
                                ...
                                for (a = n.header.length, u = 0; u < a; u++)
                                    (n.header[u].tokens = []),
                                        this.lexer.inlineTokens(n.header[u].text, n.header[u].tokens)
                                ...
                                for (c.lastIndex = 0, t = t.slice(-1 * e.length + a); null != (r = c.exec(t)); )
                                    if ((i = r[1] || r[2] || r[3] || r[4] || r[5] || r[6]))
                                        if (((o = i.length), r[3] || r[4])) s += o
                                            ...
                                            if (!((s -= o) > 0)) {
                                                if (((o = Math.min(o, o + s + l)), Math.min(a, o) % 2)) {
...
;(qf.def = wf(qf.def).replace('label', qf._label).replace('title', qf._title).getRegex()),
    (qf.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    ...
    (qf.paragraph = wf(qf._paragraph)
        ...
        .replace('tag', qf._tag)
        .getRegex()),
    (qf.blockquote = wf(qf.blockquote).replace('paragraph', qf.paragraph).getRegex()),
    (qf.normal = zf({}, qf)),
    (qf.gfm = zf({}, qf.normal, {
...
;(Zf._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
    ...
    (Zf.emStrong.lDelim = wf(Zf.emStrong.lDelim).replace(/punct/g, Zf._punctuation).getRegex()),
    (Zf.emStrong.rDelimAst = wf(Zf.emStrong.rDelimAst, 'g').replace(/punct/g, Zf._punctuation).getRegex()),
    (Zf.emStrong.rDelimUnd = wf(Zf.emStrong.rDelimUnd, 'g').replace(/punct/g, Zf._punctuation).getRegex()),
    (Zf._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (Zf._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (Zf._email =
        /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (Zf.autolink = wf(Zf.autolink).replace('scheme', Zf._scheme).replace('email', Zf._email).getRegex()),
    (Zf._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (Zf.tag = wf(Zf.tag).replace('comment', Zf._comment).replace('attribute', Zf._attribute).getRegex()),
    (Zf._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (Zf._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (Zf._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (Zf.link = wf(Zf.link)
        ...
        .getRegex()),
    (Zf.reflink = wf(Zf.reflink).replace('label', Zf._label).replace('ref', qf._label).getRegex()),
    ...
    (Zf.gfm.url = wf(Zf.gfm.url, 'i').replace('email', Zf.gfm._extended_email).getRegex()),
    (Zf.breaks = zf({}, Zf.gfm, {
...
var Qf = (function () {
        function e(n) {
            ...
            this.options.pedantic
                ...
                : this.options.gfm &&
                  ((r.block = qf.gfm), this.options.breaks ? (r.inline = Zf.breaks) : (r.inline = Zf.gfm)),
                            ...
                            for (this.options.pedantic && (e = e.replace(/^ +$/gm, '')); e; )
                                if (
                                    ...
                                    if ((t = this.tokenizer.space(e)))
                                        ...
                                        (e = e.substring(t.raw.length)),
                                            !(n = o[o.length - 1]) || ('paragraph' !== n.type && 'text' !== n.type)
                                                ? o.push(t)
                                                : ((n.raw += '\n' + t.raw),
                                                  (n.text += '\n' + t.text),
                                    ...
                                    else if ((t = this.tokenizer.list(e))) (e = e.substring(t.raw.length)), o.push(t)
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (this.tokens.links) {
                                ...
                                if (c.length > 0)
                                    for (; null != (u = this.tokenizer.rules.inline.reflinkSearch.exec(l)); )
                            ...
                            for (; null != (u = this.tokenizer.rules.inline.blockSkip.exec(l)); )
                                l =
                                    l.slice(0, u.index) +
                                    '[' +
                                    Mf('a', u[0].length - 2) +
                            ...
                            for (; null != (u = this.tokenizer.rules.inline.escapedEmSt.exec(l)); )
                                l =
                                    l.slice(0, u.index) +
                                    '++' +
                            ...
                            for (; e; )
                                if (
                                    ...
                                    if ((t = this.tokenizer.escape(e))) (e = e.substring(t.raw.length)), s.push(t)
                                        ...
                                        (e = e.substring(t.raw.length)),
                                            (n = s[s.length - 1]) && 'text' === t.type && 'text' === n.type
                                        ...
                                        (e = e.substring(t.raw.length)), s.push(t)
                                    else if (this.state.inLink || !(t = this.tokenizer.url(e, Hf))) {
                                        if (
                                            ((r = e),
                                            this.options.extensions &&
        ...
        return (
            r(e, [
                ...
                },
                {
                    key: 'link',
                    value: function (e, t, n) {
                        if (null === (e = _f(this.options.sanitize, this.options.baseUrl, e))) return n
                        var r = '<a href="' + xf(e) + '"'
                            ...
                            for (t = 0; t < E; t++)
                                if (
                                    ...
                                    !(
                                        ...
                                        (!1 ===
                                            (A = this.options.extensions.renderers[c.type].call({ parser: this }, c)) &&
                                            [
                                                'space',
                                                'hr',
                                                'heading',
                                    ...
                                    switch (c.type) {
                                        ...
                                        case 'code':
                                            ...
                                            continue
                                        case 'table':
                                            for (s = '', a = '', u = c.header.length, n = 0; n < u; n++)
                                                a += this.renderer.tablecell(this.parseInline(c.header[n].tokens), {
                                                    header: !0,
                                                    align: c.align[n],
                                                })
                                            for (
                                                s += this.renderer.tablerow(a), l = '', u = c.rows.length, n = 0;
                                                n < u;
                                                n++
                                            ) {
                                                for (a = '', i = (o = c.rows[n]).length, r = 0; r < i; r++)
                                            ...
                                            continue
                                        case 'blockquote':
                                            ;(l = this.parse(c.tokens)), (k += this.renderer.blockquote(l))
                                            continue
                                        case 'list':
                                            for (
                                                f = c.ordered,
                            ...
                            for (n = 0; n < o; n++)
                                if (
                                    ...
                                    !(
                                        ...
                                        (!1 ===
                                            (u = this.options.extensions.renderers[r.type].call({ parser: this }, r)) &&
                                            [
                                                'escape',
                                                'html',
                                                'link',
...
function Wf(e, t, n) {
    ...
    if (('function' == typeof t && ((n = t), (t = null)), Lf((t = zf({}, Wf.defaults, t || {}))), n)) {
        var r,
            u = t.highlight
        try {
            r = Qf.lex(e, t)
    ...
    try {
        ...
        if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
            return '<p>An error occurred:</p><pre>' + xf(e.message + '', !0) + '</pre>'
        throw e
    }
}
;(Wf.options = Wf.setOptions =
                            ...
                            i[e.level] ? i[e.level].unshift(e.tokenizer) : (i[e.level] = [e.tokenizer]),
                                e.start &&
                                    ('block' === e.level
                                        ...
                                        : 'inline' === e.level &&
                                          (i.startInline ? i.startInline.push(e.start) : (i.startInline = [e.start])))
                        }
                ...
                switch ((t.call(Wf, e), e.type)) {
                    ...
                    default:
                        ...
                        Wf.defaults.extensions.childTokens[e.type]
                            ? Wf.defaults.extensions.childTokens[e.type].forEach(function (n) {
                                  Wf.walkTokens(e[n], t)
                              })
    ...
    (Wf.parseInline = function (e, t) {
        ...
        try {
            ...
            return t.walkTokens && Wf.walkTokens(n, t.walkTokens), Xf.parseInline(n, t)
        } catch (e) {
            if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
                return '<p>An error occurred:</p><pre>' + xf(e.message + '', !0) + '</pre>'
            throw e
...
export default function () {
    ...
    function a(e, t) {
        ...
        return (
            2 === n.length && (e = n[0] + '<aside class="notes">' + Wf(n[1].trim()) + '</aside>'),
    ...
    function c(e, t, n) {
        ...
        if ((r = i.exec(a))) {
            var s = r[1]
            for (a = a.substring(0, r.index) + a.substring(i.lastIndex), e.nodeValue = a; (u = o.exec(s)); )
