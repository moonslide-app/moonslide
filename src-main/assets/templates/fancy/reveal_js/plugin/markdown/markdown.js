!(function (e, t) {
    ...
    var Ye = {
            ...
            getterFor: function (e) {
                return function (t) {
                    var n
                    if (!ze(t) || (n = be(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
                    return n
                }
            },
        },
    ...
    ;(le.exports = function (e, t, n, r) {
        ...
        'function' == typeof n &&
            ...
            e !== Ke
                ? (i ? !a && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : Xe(e, t, n))
                : o
                ? (e[t] = n)
                : Je(t, n)
    ...
    bn
        ...
        : En && (!(An = En.match(/Edge\/(\d+)/)) || An[1] >= 74) && (An = En.match(/Chrome\/(\d+)/)) && (mn = An[1])
    var Cn = mn && +mn,
        wn = Cn,
        Bn = D,
        Sn =
        ...
        Jn = function (e, t, n, r) {
            ...
            if (!i || !o || ('replace' === e && (!Vn || !Yn || Xn)) || ('split' === e && !Wn)) {
                var a = /./[u],
                    s = n(
                        u,
                        ''[e],
                        ...
                        { REPLACE_KEEPS_$0: Yn, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Xn }
                    ),
                    l = s[0],
                    c = s[1]
        ...
        return [
            ...
            function (e, r) {
                ...
                for (var g, d = '', v = 0, y = 0; y < h.length; y++) {
                    D = h[y]
                    for (var A = String(D[0]), m = Er(xr(vr(D.index), l.length), 0), k = [], E = 1; E < D.length; E++)
    ...
    if (
        ...
        Nr(
            ...
            !ru ||
                uu ||
                Yr(function () {
                    return (nu[Wr] = !1), Jr(tu) != tu || Jr(nu) == nu || '/a/i' != Jr(tu, 'i')
                })
        )
    ) {
        for (
        ...
        return [
            ...
            function (e) {
                ...
                for (var a, s = [], l = 0; null !== (a = Eu(u, i)); ) {
                    var c = String(a[0])
                    ;(s[l] = c), '' === c && (u.lastIndex = ku(i, Au(u.lastIndex), o)), l++
                }
                return 0 === l ? null : s
            },
        ]
                        ...
                        ? function (e, n) {
                              ...
                              for (
                                  ...
                                  !(
                                      ...
                                      i.length > 1 && i.index < r.length && Xu.apply(s, i.slice(1)),
                                      (a = i[0].length),
                                      (c = o),
                                      s.length >= u)
                                  );
                ...
                [
                    ...
                    function (e, u) {
                        ...
                        for (var h = 0, D = 0, g = []; D < a.length; ) {
                            ...
                            if (null === v || (d = Wu(Qu(f.lastIndex + (Ku ? D : 0)), a.length)) === h) D = Hu(a, D, l)
                            else {
    ...
    var fi = {
        ...
        Ai = function (e, t) {
            ...
            return (
                vi(e) &&
                    ('function' != typeof (n = e.constructor) || (n !== Array && !vi(n.prototype))
    ...
    ;(Io && jo) ||
        ...
        Oo
            ...
            : $o && !To
            ? ((Eo = (ko = new $o()).port2), (ko.port1.onmessage = Zo), (mo = Bo(Eo.postMessage, Eo, 1)))
            : Co.addEventListener &&
    ...
    var ya,
        ...
        Ma = function (e, t, n) {
            var r,
                ...
                d = function (e) {
                    return f ? (so(e), h ? D(e[0], e[1], g) : D(e[0], e[1])) : h ? D(e, g) : D(e)
                }
            if (p) r = e
            else {
                if ('function' != typeof (u = po(e))) throw TypeError('Target is not iterable')
                if (lo(u)) {
                    for (i = 0, o = co(e.length); o > i; i++) if ((a = d(e[i])) && a instanceof Do) return a
                    return new Do(!1)
                }
                r = u.call(e)
            }
        ...
        vs = Ka(ts, function () {
            ...
            return ((t.constructor = {})[es] = n), !(ds = t.then(function () {}) instanceof n) || (!e && Xa && !Ds)
        }),
        ys =
            vs ||
            !Na(function (e) {
                        ...
                        try {
                            c
                                ? (u || (2 === e.rejection && Fs(e), (e.rejection = 1)),
                                  ...
                                  o === l.promise ? p(ss('Promise-chain cycle')) : (a = As(o)) ? a.call(o, f, p) : f(o))
                                : p(r)
                        } catch (e) {
                            h && !s && h.exit(), p(e)
                        }
        ...
        ks = function (e, t, n) {
            ...
            hs
                ...
                !Ds && (u = Ba['on' + e]) ? u(r) : e === gs && Ha('Unhandled promise rejection', n)
        },
        Es = function (e) {
            qa.call(Ba, function () {
                var t,
        ...
        Fs = function (e) {
            qa.call(Ba, function () {
                var t = e.facade
                Wa ? cs.emit('rejectionHandled', t) : ks('rejectionhandled', t, e.value)
            })
        },
        bs = function (e, t, n) {
            return function (r) {
        ...
        Cs = function (e, t, n) {
            e.done || ((e.done = !0), n && (e = n), (e.value = t), (e.state = 2), ms(e, !0))
        },
        ws = function (e, t, n) {
            if (!e.done) {
                ;(e.done = !0), n && (e = n)
    ...
    zs(
        { target: 'Array', proto: !0, forced: !Zs },
        {
            slice: function (e, t) {
                ...
                if (
                    Ps(i) &&
                    ('function' != typeof (n = i.constructor) || (n !== Array && !Ps(n.prototype))
                        ? $s(n) && null === (n = n[Gs]) && (n = void 0)
                        : (n = void 0),
                    n === Array || void 0 === n)
                )
                    return Hs.call(i, a, s)
                for (r = new (void 0 === n ? Array : n)(Qs(s - a, 0)), u = 0; a < s; a++, u++) a in i && Us(r, u, i[a])
                return (r.length = u), r
            },
        }
    )
    var Vs,
        ...
        tl = g
            ...
            : function (e, t) {
                  Js(e)
                  for (var n, r = el(t), u = r.length, i = 0; u > i; ) Ws.f(e, (n = r[i++]), t[n])
                  return e
              },
        nl = ee,
        rl = tl,
    ...
    var pl =
            ...
            function (e, t) {
                ...
                return (
                    null !== e
                        ? ((ll.prototype = nl(e)), (n = new ll()), (ll.prototype = null), (n[sl] = e))
                        : (n = fl()),
                    void 0 === t ? n : rl(n, t)
                )
            },
    ...
    var vl,
        ...
        Ol = Mn('iterator'),
        Rl = !1
    ;[].keys && ('next' in (Al = [].keys()) ? (yl = Sl(Sl(Al))) !== Object.prototype && (vl = yl) : (Rl = !0)),
        (null == vl ||
            Bl(function () {
                var e = {}
    ...
    var Il = { IteratorPrototype: vl, BUGGY_SAFARI_ITERATORS: Rl },
        ...
        Ul = function (e, t, n) {
            var r = t + ' Iterator'
            return (e.prototype = zl(jl, { next: $l(1, n) })), Pl(e, r, !1), (Ll[r] = Ml), e
        },
        ql = wl,
        Zl = wr,
        Gl = Ji,
        ...
        nc = function (e, t, n, r, u, i, o) {
            ...
            if (
                (d &&
                    ...
                    Yl !== Object.prototype &&
                        a.next &&
                        (ql(a) !== Yl && (Zl ? Zl(a, Yl) : 'function' != typeof a[Xl] && Hl(a, Xl, tc)), Gl(a, f, !0))),
                u == Jl &&
                    D &&
                    D.name !== Jl &&
                    ((p = !0),
        ...
        { target: 'Array', proto: !0, forced: !Jc },
        {
            splice: function (e, t) {
                ...
                if (
                    ...
                    throw TypeError(rf)
                for (u = Xc(s, r), i = 0; i < r; i++) (o = c + i) in s && Wc(u, i, s[o])
                if (((u.length = r), n < r)) {
    ...
    var of = nn,
        ...
        lf = sf
            ...
            : ''.trimStart
    of({ target: 'String', proto: !0, forced: sf }, { trimStart: lf, trimLeft: lf })
    var cf =
            Object.is ||
            function (e, t) {
    ...
    Jn('search', 1, function (e, t, n) {
        return [
            ...
            function (e) {
                ...
                var a = Df(u, i)
                return hf(u.lastIndex, o) || (u.lastIndex = o), null === a ? -1 : a.index
            },
        ]
    })
    var gf = nn,
        ...
        yf = vf
            ...
            : ''.trimEnd
    gf({ target: 'String', proto: !0, forced: vf }, { trimEnd: yf, trimRight: yf })
    var Af = wi.filter
    nn(
    ...
    var mf = C,
        ...
        xf = function (e, t, n, r) {
            var u = String(mf(e)),
                i = '<' + t
            return (
                '' !== n && (i += ' ' + n + '="' + String(r).replace(kf, '&quot;') + '"'), i + '>' + u + '</' + t + '>'
            )
        }
    nn(
        {
    ...
    var Bf = Rr,
        Sf = Mn('match'),
        _f = function (e) {
            if (Bf(e)) throw TypeError("The method doesn't accept regular expressions")
            return e
        },
        Tf = C
    function Of() {
    ...
    nn(
        ...
        {
            includes: function (e) {
                return !!~String(Tf(this)).indexOf(_f(e), arguments.length > 1 ? arguments[1] : void 0)
            },
        }
    )
    var Rf = {
    ...
    function Zf(e, t) {
        ...
        var n = {
            replace: function (t, r) {
                return (r = (r = r.source || r).replace(qf, '$1')), (e = e.replace(t, r)), n
            },
            getRegex: function () {
    ...
    function Qf(e, t, n) {
        ...
        t &&
            !Hf.test(n) &&
            (n = (function (e, t) {
                Vf[' ' + e] || (Yf.test(e) ? (Vf[' ' + e] = e + '/') : (Vf[' ' + e] = tp(e, '/', !0)))
                            ...
                            if (t) {
                                ...
                                return (
                                    this.options.sanitize &&
                                        ((n.type = 'paragraph'),
                                        (n.text = this.options.sanitizer ? this.options.sanitizer(t[0]) : Mf(t[0])),
                                        (n.tokens = []),
                            ...
                            if (t) {
                                ...
                                if (n.header.length === n.align.length) {
                                    ...
                                    for (a = n.rows.length, r = 0; r < a; r++)
                                        n.rows[r] = ep(n.rows[r], n.header.length).map(function (e) {
                                            return { text: e }
                                        })
                        ...
                        value: function (e, t) {
                            ...
                            if (u)
                                return (
                                    (r =
                                        '@' === u[2]
                                            ? 'mailto:' + (n = Mf(this.options.mangle ? t(u[1]) : u[1]))
                                            : (n = Mf(u[1]))),
                                    {
                                        type: 'link',
                                        raw: u[0],
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if ((n = this.rules.inline.url.exec(e))) {
                                var r, u
                                if ('@' === n[2]) u = 'mailto:' + (r = Mf(this.options.mangle ? t(n[0]) : n[0]))
                                else {
                                    var i
                                    do {
    ...
    ;(op.def = Zf(op.def).replace('label', op._label).replace('title', op._title).getRegex()),
        (op.bullet = /(?:[*+-]|\d{1,9}[.)])/),
        ...
        (op.paragraph = Zf(op._paragraph)
            ...
            .replace('tag', op._tag)
            .getRegex()),
        (op.blockquote = Zf(op.blockquote).replace('paragraph', op.paragraph).getRegex()),
        (op.normal = Jf({}, op)),
        (op.gfm = Jf({}, op.normal, {
    ...
    ;(ap._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
        ...
        (ap.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
        (ap.escapedEmSt = /\\\*|\\_/g),
        (ap._comment = Zf(op._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
        (ap.emStrong.lDelim = Zf(ap.emStrong.lDelim).replace(/punct/g, ap._punctuation).getRegex()),
        (ap.emStrong.rDelimAst = Zf(ap.emStrong.rDelimAst, 'g').replace(/punct/g, ap._punctuation).getRegex()),
        (ap.emStrong.rDelimUnd = Zf(ap.emStrong.rDelimUnd, 'g').replace(/punct/g, ap._punctuation).getRegex()),
        (ap._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
        (ap._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
        (ap._email =
            /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
        (ap.autolink = Zf(ap.autolink).replace('scheme', ap._scheme).replace('email', ap._email).getRegex()),
        (ap._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
        (ap.tag = Zf(ap.tag).replace('comment', ap._comment).replace('attribute', ap._attribute).getRegex()),
        (ap._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
        (ap._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
        (ap._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
        (ap.link = Zf(ap.link)
            ...
            .getRegex()),
        (ap.reflink = Zf(ap.reflink).replace('label', ap._label).replace('ref', op._label).getRegex()),
        ...
        (ap.gfm.url = Zf(ap.gfm.url, 'i').replace('email', ap.gfm._extended_email).getRegex()),
        (ap.breaks = Jf({}, ap.gfm, {
    ...
    var cp = (function () {
            function e(n) {
                ...
                this.options.pedantic
                    ...
                    : this.options.gfm &&
                      ((r.block = op.gfm), this.options.breaks ? (r.inline = ap.breaks) : (r.inline = ap.gfm)),
                                ...
                                for (; e; )
                                    if (
                                        ...
                                        if ((t = this.tokenizer.escape(e))) (e = e.substring(t.raw.length)), s.push(t)
                                            ...
                                            (e = e.substring(t.raw.length)), s.push(t)
                                        else if (this.state.inLink || !(t = this.tokenizer.url(e, lp))) {
                                            if (
                                                ((r = e),
                                                this.options.extensions &&
            ...
            return (
                r(e, [
                    ...
                    },
                    {
                        key: 'link',
                        value: function (e, t, n) {
                            if (null === (e = Qf(this.options.sanitize, this.options.baseUrl, e))) return n
                            var r = '<a href="' + Mf(e) + '"'
    ...
    function gp(e, t, n) {
        ...
        if (('function' == typeof t && ((n = t), (t = null)), np((t = Jf({}, gp.defaults, t || {}))), n)) {
            var r,
                u = t.highlight
            try {
                r = cp.lex(e, t)
            ...
            var i = function (e) {
                ...
                if (!e)
                    try {
                        t.walkTokens && gp.walkTokens(r, t.walkTokens), (i = Dp.parse(r, t))
                    } catch (t) {
                        e = t
                    }
        ...
        try {
            ...
            if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
                return '<p>An error occurred:</p><pre>' + Mf(e.message + '', !0) + '</pre>'
            throw e
        }
    }
    ;(gp.options = gp.setOptions =
                    ...
                    switch ((t.call(gp, e), e.type)) {
                        ...
                        default:
                            ...
                            gp.defaults.extensions.childTokens[e.type]
                                ? gp.defaults.extensions.childTokens[e.type].forEach(function (n) {
                                      gp.walkTokens(e[n], t)
                                  })
        ...
        (gp.parseInline = function (e, t) {
            ...
            try {
                ...
                return t.walkTokens && gp.walkTokens(n, t.walkTokens), Dp.parseInline(n, t)
            } catch (e) {
                if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
                    return '<p>An error occurred:</p><pre>' + Mf(e.message + '', !0) + '</pre>'
                throw e
    ...
    return function () {
        ...
        function a(e, t) {
            ...
            return (
                2 === n.length && (e = n[0] + '<aside class="notes">' + gp(n[1].trim()) + '</aside>'),
                '<script type="text/template">' + (e = e.replace(/<\/script>/g, dp)) + '</script>'
            )
        }
        function s(e, t) {
            t = o(t)
