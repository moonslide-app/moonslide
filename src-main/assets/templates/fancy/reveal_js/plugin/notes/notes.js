!(function (t, e) {
    ...
    var ht,
        ...
        vt = Math.random(),
        yt = function (t) {
            return 'Symbol(' + String(void 0 === t ? '' : t) + ')_' + (++mt + vt).toString(36)
        },
        kt = dt.exports,
        Et = yt,
        xt = kt('keys'),
    ...
    var Mt = {
            ...
            getterFor: function (t) {
                return function (e) {
                    var n
                    if (!Ct(e) || (n = gt(e)).type !== t) throw TypeError('Incompatible receiver, ' + t + ' required')
                    return n
                }
            },
        },
    ...
    ;(X.exports = function (t, e, n, r) {
        ...
        'function' == typeof n &&
            ...
            (i = Wt(n)).source || (i.source = Jt.join('string' == typeof e ? e : ''))),
            t !== jt
                ? (u ? !o && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : Nt(t, e, n))
                : a
                ? (t[e] = n)
                : qt(e, n)
    ...
    var Vt = n,
        ...
        Gt = function (t, e) {
            return arguments.length < 2 ? Qt(Vt[t]) || Qt(Kt[t]) : (Vt[t] && Vt[t][e]) || (Kt[t] && Kt[t][e])
        },
        Yt = {},
        Xt = Math.ceil,
        te = Math.floor,
    ...
    var Ye = Ve,
        ...
        un = (function () {
            var t = /a/,
                e = /b*/g
            return en.call(t, 'a'), en.call(e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
        })(),
    ...
    hn
        ...
        : pn && (!(ln = pn.match(/Edge\/(\d+)/)) || ln[1] >= 74) && (ln = pn.match(/Chrome\/(\d+)/)) && (cn = ln[1])
    var gn = cn && +cn,
        Dn = gn,
        mn = i,
        vn =
        ...
        Un = function (t, e, n, r) {
            ...
            if (!u || !a || ('replace' === t && (!$n || !Pn || jn)) || ('split' === t && !Nn)) {
                var o = /./[i],
                    s = n(
                        i,
                        ''[t],
                        ...
                        { REPLACE_KEEPS_$0: Pn, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: jn }
                    ),
                    l = s[0],
                    c = s[1]
        ...
        Wn = function (t, e) {
            ...
            if ('RegExp' !== Zn(t)) throw TypeError('RegExp#exec called on incompatible receiver')
            return Hn.call(t, e)
        },
        Jn = Z,
        Vn = D,
    ...
    Un('search', 1, function (t, e, n) {
        return [
            ...
            function (t) {
                ...
                var o = Qn(i, u)
                return Kn(i.lastIndex, a) || (i.lastIndex = a), null === o ? -1 : o.index
            },
        ]
    })
    var Gn = ee,
        ...
        return [
            ...
            function (t) {
                ...
                for (var o, s = [], l = 0; null !== (o = ar(i, u)); ) {
                    var c = String(o[0])
                    ;(s[l] = c), '' === c && (i.lastIndex = ur(u, rr(i.lastIndex), a)), l++
                }
                return 0 === l ? null : s
            },
        ]
        ...
        return [
            ...
            function (t, r) {
                ...
                for (var g, D = '', m = 0, v = 0; v < f.length; v++) {
                    h = f[v]
                    for (var y = String(h[0]), k = Fr(Sr(xr(h.index), l.length), 0), E = [], x = 1; x < h.length; x++)
    ...
    var Br = k,
        Tr = Z,
        _r = function (t) {
            if (!Br(t) && null !== t) throw TypeError("Can't set " + String(t) + ' as a prototype')
            return t
        },
        zr =
    ...
    if (
        ...
        Hr(
            ...
            !oi ||
                si ||
                Xr(function () {
                    return (ai[ni] = !1), ri(ui) != ui || ri(ai) == ai || '/a/i' != ri(ui, 'i')
                })
        )
    ) {
        for (
            var li = function (t, e) {
                    ...
                    oi ? i && !u && (t = t.source) : t instanceof li && (u && (e = Qr.call(t)), (t = t.source)),
    ...
    ;(ki || Ei) &&
            ...
            function () {
                var t = hi(this),
                    e = String(t.source),
                    n = t.flags
                return '/' + e + '/' + String(void 0 === n && t instanceof RegExp && !('flags' in vi) ? Di.call(t) : n)
            },
            { unsafe: !0 }
        )
    var xi = function (t) {
                        ...
                        ? function (t, n) {
                              ...
                              for (
                                  ...
                                  !(
                                      ...
                                      u.length > 1 && u.index < r.length && Oi.apply(s, u.slice(1)),
                                      (o = u[0].length),
                                      (c = a),
                                      s.length >= i)
                                  );
                ...
                [
                    ...
                    function (t, i) {
                        ...
                        for (var f = 0, h = 0, g = []; h < o.length; ) {
                            ...
                            if (null === m || (D = $i(zi(p.lastIndex + (Li ? h : 0)), o.length)) === f) h = _i(o, h, l)
                            else {
    ...
    var Mi = '\t\n\v\f\r                　\u2028\u2029\ufeff',
        ...
        Zi = function (t) {
            return function (e) {
                var n = String(ji(e))
                return 1 & t && (n = n.replace(Ui, '')), 2 & t && (n = n.replace(qi, '')), n
            }
        },
    ...
    var Qi = d,
        ...
        eu = function (t, e) {
            ...
            return (
                Xi(t) &&
                    ('function' != typeof (n = t.constructor) || (n !== Array && !Xi(n.prototype))
        ...
        { target: 'Array', proto: !0, forced: !mu },
        {
            splice: function (t, e) {
                ...
                if (
                    ...
                    throw TypeError(Eu)
                for (i = gu(s, r), u = 0; u < r; u++) (a = c + u) in s && Du(i, u, s[a])
                if (((i.length = r), n < r)) {
    ...
    Mu(
        { target: 'Array', proto: !0, forced: !Ju },
        {
            slice: function (t, e) {
                ...
                if (
                    Nu(u) &&
                    ('function' != typeof (n = u.constructor) || (n !== Array && !Nu(n.prototype))
                        ? ju(n) && null === (n = n[Vu]) && (n = void 0)
                        : (n = void 0),
                    n === Array || void 0 === n)
                )
                    return Ku.call(u, o, s)
                for (r = new (void 0 === n ? Array : n)(Qu(s - o, 0)), i = 0; o < s; o++, i++) o in u && Hu(r, i, u[o])
                return (r.length = i), r
            },
        }
    )
    var Gu = We,
        ...
        ta = Xu
            ...
            : ''.trimStart
    Gu({ target: 'String', proto: !0, forced: Xu }, { trimStart: ta, trimLeft: ta })
    var ea = We,
        na = Hi.end,
        ra = Vi('trimEnd'),
        ia = ra
            ...
            : ''.trimEnd
    ea({ target: 'String', proto: !0, forced: ra }, { trimEnd: ia, trimRight: ia })
    var ua = $u.filter
    We(
    ...
    var aa = D,
        ...
        la = function (t, e, n, r) {
            var i = String(aa(t)),
                u = '<' + e
            return (
                '' !== n && (u += ' ' + n + '="' + String(r).replace(oa, '&quot;') + '"'), u + '>' + i + '</' + e + '>'
            )
        }
    We(
        {
    ...
    var Ia,
        ...
        Pa = u
            ...
            : function (t, e) {
                  Oa(t)
                  for (var n, r = $a(e), i = r.length, u = 0; i > u; ) La.f(t, (n = r[u++]), e[n])
                  return t
              },
    ...
    var Qa =
            ...
            function (t, e) {
                ...
                return (
                    null !== t
                        ? ((Ja.prototype = ja(t)), (n = new Ja()), (Ja.prototype = null), (n[Wa] = t))
                        : (n = Ka()),
                    void 0 === e ? n : Na(n, e)
                )
            },
    ...
    var no = Pr,
        ro = Bn('match'),
        io = function (t) {
            if (no(t)) throw TypeError("The method doesn't accept regular expressions")
            return t
        },
        uo = D
    We(
        ...
        {
            includes: function (t) {
                return !!~String(uo(this)).indexOf(io(t), arguments.length > 1 ? arguments[1] : void 0)
            },
        }
    )
    var ao = We,
    ...
    function No(t, e) {
        ...
        var n = {
            replace: function (e, r) {
                return (r = (r = r.source || r).replace(jo, '$1')), (t = t.replace(e, r)), n
            },
            getRegex: function () {
    ...
    function Zo(t, e, n) {
        ...
        e &&
            !qo.test(n) &&
            (n = (function (t, e) {
                Ho[' ' + t] || (Wo.test(t) ? (Ho[' ' + t] = t + '/') : (Ho[' ' + t] = Yo(t, '/', !0)))
                            ...
                            if (e) {
                                ...
                                return (
                                    this.options.sanitize &&
                                        ((n.type = 'paragraph'),
                                        (n.text = this.options.sanitizer ? this.options.sanitizer(e[0]) : $o(e[0])),
                                        (n.tokens = []),
                            ...
                            if (e) {
                                ...
                                if (n.header.length === n.align.length) {
                                    ...
                                    for (o = n.rows.length, r = 0; r < o; r++)
                                        n.rows[r] = Go(n.rows[r], n.header.length).map(function (t) {
                                            return { text: t }
                                        })
                        ...
                        value: function (t, e) {
                            ...
                            if (i)
                                return (
                                    (r =
                                        '@' === i[2]
                                            ? 'mailto:' + (n = $o(this.options.mangle ? e(i[1]) : i[1]))
                                            : (n = $o(i[1]))),
                                    {
                                        type: 'link',
                                        raw: i[0],
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if ((n = this.rules.inline.url.exec(t))) {
                                var r, i
                                if ('@' === n[2]) i = 'mailto:' + (r = $o(this.options.mangle ? e(n[0]) : n[0]))
                                else {
                                    var u
                                    do {
    ...
    ;(rs.def = No(rs.def).replace('label', rs._label).replace('title', rs._title).getRegex()),
        (rs.bullet = /(?:[*+-]|\d{1,9}[.)])/),
        ...
        (rs.paragraph = No(rs._paragraph)
            ...
            .replace('tag', rs._tag)
            .getRegex()),
        (rs.blockquote = No(rs.blockquote).replace('paragraph', rs.paragraph).getRegex()),
        (rs.normal = Qo({}, rs)),
        (rs.gfm = Qo({}, rs.normal, {
    ...
    ;(is._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
        ...
        (is.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
        (is.escapedEmSt = /\\\*|\\_/g),
        (is._comment = No(rs._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
        (is.emStrong.lDelim = No(is.emStrong.lDelim).replace(/punct/g, is._punctuation).getRegex()),
        (is.emStrong.rDelimAst = No(is.emStrong.rDelimAst, 'g').replace(/punct/g, is._punctuation).getRegex()),
        (is.emStrong.rDelimUnd = No(is.emStrong.rDelimUnd, 'g').replace(/punct/g, is._punctuation).getRegex()),
        (is._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
        (is._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
        (is._email =
            /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
        (is.autolink = No(is.autolink).replace('scheme', is._scheme).replace('email', is._email).getRegex()),
        (is._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
        (is.tag = No(is.tag).replace('comment', is._comment).replace('attribute', is._attribute).getRegex()),
        (is._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
        (is._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
        (is._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
        (is.link = No(is.link)
            ...
            .getRegex()),
        (is.reflink = No(is.reflink).replace('label', is._label).replace('ref', rs._label).getRegex()),
        ...
        (is.gfm.url = No(is.gfm.url, 'i').replace('email', is.gfm._extended_email).getRegex()),
        (is.breaks = Qo({}, is.gfm, {
    ...
    var os = (function () {
            function t(e) {
                ...
                this.options.pedantic
                    ...
                    : this.options.gfm &&
                      ((n.block = rs.gfm), this.options.breaks ? (n.inline = is.breaks) : (n.inline = is.gfm)),
                                ...
                                for (; t; )
                                    if (
                                        ...
                                        if ((e = this.tokenizer.escape(t))) (t = t.substring(e.raw.length)), s.push(e)
                                            ...
                                            (t = t.substring(e.raw.length)), s.push(e)
                                        else if (this.state.inLink || !(e = this.tokenizer.url(t, as))) {
                                            if (
                                                ((r = t),
                                                this.options.extensions &&
            ...
            return (
                lr(t, [
                    ...
                    },
                    {
                        key: 'link',
                        value: function (t, e, n) {
                            if (null === (t = Zo(this.options.sanitize, this.options.baseUrl, t))) return n
                            var r = '<a href="' + $o(t) + '"'
    ...
    function ds(t, e, n) {
        ...
        if (('function' == typeof e && ((n = e), (e = null)), Xo((e = Qo({}, ds.defaults, e || {}))), n)) {
            var r,
                i = e.highlight
            try {
                r = os.lex(t, e)
            ...
            var u = function (t) {
                ...
                if (!t)
                    try {
                        e.walkTokens && ds.walkTokens(r, e.walkTokens), (u = ps.parse(r, e))
                    } catch (e) {
                        t = e
                    }
        ...
        try {
            ...
            if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
                return '<p>An error occurred:</p><pre>' + $o(t.message + '', !0) + '</pre>'
            throw t
        }
    }
    ;(ds.options = ds.setOptions =
                    ...
                    switch ((e.call(ds, t), t.type)) {
                        ...
                        default:
                            ...
                            ds.defaults.extensions.childTokens[t.type]
                                ? ds.defaults.extensions.childTokens[t.type].forEach(function (n) {
                                      ds.walkTokens(t[n], e)
                                  })
        ...
        (ds.parseInline = function (t, e) {
            ...
            try {
                ...
                return e.walkTokens && ds.walkTokens(n, e.walkTokens), ps.parseInline(n, e)
            } catch (t) {
                if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
                    return '<p>An error occurred:</p><pre>' + $o(t.message + '', !0) + '</pre>'
                throw t
    ...
    return function () {
        ...
        function r() {
            if (n && !n.closed) n.focus()
                ...
                if (
                    (((n = window.open('about:blank', 'reveal.js - Notes', 'width=1100,height=700')).marked = ds),
                    n.document.write(
        ...
        function i(t) {
            ...
            if (
                (r.hasAttribute('data-notes') &&
                    ((a.notes = r.getAttribute('data-notes')), (a.whitespace = 'pre-wrap')),
                u)
            ) {
        ...
        function u(r) {
            ...
            l && 'reveal-notes' === l.namespace && 'connected' === l.type
                ...
                : l &&
                  ...
                  (s = e[i].apply(e, u)),
                  n.postMessage(
                      JSON.stringify({ namespace: 'reveal-notes', type: 'return', result: s, callId: o }),
                      '*'
                  ))
        }
        function a() {
