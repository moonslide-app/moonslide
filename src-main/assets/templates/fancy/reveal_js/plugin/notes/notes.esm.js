...
var Q = U,
    ...
    rt = nt,
    it = n['__core-js_shared__'] || rt('__core-js_shared__', {}),
    ut = it,
...
var ot = ut.inspectSource,
    st = ot,
    lt = n.WeakMap,
    ct = 'function' == typeof lt && /native code/.test(st(lt)),
    pt = { exports: {} },
    dt = it
...
var ft,
    ...
    mt = Math.random(),
    vt = function (t) {
        return 'Symbol(' + String(void 0 === t ? '' : t) + ')_' + (++Dt + mt).toString(36)
    },
    yt = pt.exports,
    kt = vt,
    Et = yt('keys'),
    xt = function (t) {
        return Et[t] || (Et[t] = kt(t))
    },
    At = {},
    bt = ct,
    wt = k,
    ...
    _t = n.WeakMap
if (bt || St.state) {
    var zt = St.state || (St.state = new _t()),
        Rt = zt.get,
        It = zt.has,
        Lt = zt.set
    ;(ft = function (t, e) {
        if (It.call(zt, t)) throw new TypeError('Object already initialized')
        return (e.facade = t), Lt.call(zt, t, e), e
    }),
        (ht = function (t) {
            return Rt.call(zt, t) || {}
        }),
    ...
    ;(Tt[Ot] = !0),
        (ft = function (t, e) {
            if (Ft(t, Ot)) throw new TypeError('Object already initialized')
            return (e.facade = t), Ct(t, Ot, e), e
        }),
        (ht = function (t) {
            return Ft(t, Ot) ? t[Ot] : {}
        }),
...
var $t = {
        ...
        getterFor: function (t) {
            return function (e) {
                var n
                if (!wt(e) || (n = ht(e)).type !== t) throw TypeError('Incompatible receiver, ' + t + ' required')
                return n
            }
        },
    },
...
;(X.exports = function (t, e, n, r) {
    var i,
        ...
        o = !!r && !!r.noTargetGet
    'function' == typeof n &&
        ('string' != typeof e || jt(n, 'name') || Mt(n, 'name', e),
        (i = Zt(n)).source || (i.source = Ht.join('string' == typeof e ? e : ''))),
        t !== Pt ? (u ? !o && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : Mt(t, e, n)) : a ? (t[e] = n) : Nt(e, n)
...
var Wt = n,
    ...
    Kt = function (t, e) {
        return arguments.length < 2 ? Vt(Wt[t]) || Vt(Jt[t]) : (Wt[t] && Wt[t][e]) || (Jt[t] && Jt[t][e])
    },
    Qt = {},
    Gt = Math.ceil,
    Yt = Math.floor,
    ...
    ce = function (t) {
        return function (e, n, r) {
            ...
            } else for (; a > o; o++) if ((t || o in u) && u[o] === n) return t || o || 0
            return !t && -1
        }
    },
    ...
    De = function (t, e) {
        var n,
            ...
            i = 0,
            u = []
        for (n in r) !de(ge, n) && de(r, n) && u.push(n)
        for (; e.length > i; ) de(r, (n = e[i++])) && (~he(u, n) || u.push(n))
        return u
    },
    me = [
        'constructor',
...
var Ee = Qt,
    ...
    _e = function (t, e) {
        var n = Re[ze(t)]
        return n == Le || (n != Ie && ('function' == typeof e ? Be(e) : !!e))
    },
    ze = (_e.normalize = function (t) {
    ...
    Ne = nt,
    Ue = function (t, e) {
        for (var n = Ce(e), r = Se.f, i = Fe.f, u = 0; u < n.length; u++) {
            var a = n[u]
            we(t, a) || r(t, a, i(e, a))
        }
    },
    ...
    Ze = function (t, e) {
        var n,
            ...
            s = t.global,
            l = t.stat
        if ((n = s ? $e : l ? $e[o] || Ne(o, {}) : ($e[o] || {}).prototype))
            for (r in e) {
                if (
                    ((u = e[r]),
                    (i = t.noTargetGet ? (a = Pe(n, r)) && a.value : n[r]),
                    !qe(s ? r : o + (l ? '.' : '#') + r, t.forced) && void 0 !== i)
                ) {
                    if (typeof u == typeof i) continue
                    Ue(u, i)
                }
                ;(t.sham || (i && i.sham)) && Me(u, 'sham', !0), je(n, r, u, t)
            }
    },
    He = Z,
    We = function () {
...
var Qe = We,
    ...
    tn = Ye('native-string-replace', String.prototype.replace),
    en = Xe,
    nn = (function () {
        var t = /a/,
            e = /b*/g
        return Xe.call(t, 'a'), Xe.call(e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
    })(),
    rn = Ge.UNSUPPORTED_Y || Ge.BROKEN_CARET,
    un = void 0 !== /()??/.exec('')[1]
;(nn || un || rn) &&
    (en = function (t) {
        var e,
        ...
        return (
            ...
            a
                ? r
                    ...
                    : (u.lastIndex = 0)
                : nn && r && (u.lastIndex = u.global ? r.index + r[0].length : e),
            un &&
                r &&
                r.length > 1 &&
...
var on,
    sn,
    ln = Kt('navigator', 'userAgent') || '',
    cn = n.process,
    pn = cn && cn.versions,
    dn = pn && pn.v8
dn
    ? (sn = (on = dn.split('.'))[0] < 4 ? 1 : on[0] + on[1])
    : ln && (!(on = ln.match(/Edge\/(\d+)/)) || on[1] >= 74) && (on = ln.match(/Chrome\/(\d+)/)) && (sn = on[1])
var fn = sn && +sn,
    hn = fn,
    gn = i,
    Dn =
    ...
    bn = yn('wks'),
    wn = vn.Symbol,
    Cn = An ? wn : (wn && wn.withoutSetter) || En,
    Fn = function (t) {
        return (
            (kn(bn, t) && (xn || 'string' == typeof bn[t])) ||
                (xn && kn(wn, t) ? (bn[t] = wn[t]) : (bn[t] = Cn('Symbol.' + t))),
            bn[t]
        )
    },
    Sn = X.exports,
    ...
    jn = function (t, e, n, r) {
        ...
        if (!u || !a || ('replace' === t && (!Ln || !On || Pn)) || ('split' === t && !Mn)) {
            var o = /./[i],
                s = n(
                    i,
                    ''[t],
                    function (t, e, n, r, i) {
                        var a = e.exec
                        return a === Bn || a === In.exec
                            ? u && !i
                                ? { done: !0, value: o.call(e, n, r) }
                                : { done: !0, value: t.call(n, e, r) }
                            : { done: !1 }
                    },
                    { REPLACE_KEEPS_$0: On, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Pn }
                ),
                l = s[0],
                c = s[1]
            Sn(String.prototype, t, l),
                Sn(
                    In,
                    i,
                    2 == e
    ...
    Zn = function (t, e) {
        ...
        if ('RegExp' !== Un(t)) throw TypeError('RegExp#exec called on incompatible receiver')
        return qn.call(t, e)
    },
    Hn = Z,
    Wn = D,
    ...
    return [
        ...
        function (t) {
            ...
            var i = Hn(t),
                u = String(this),
                a = i.lastIndex
            Jn(a, 0) || (i.lastIndex = 0)
            var o = Vn(i, u)
            return Jn(i.lastIndex, a) || (i.lastIndex = a), null === o ? -1 : o.index
        },
    ]
})
var Kn = Xt,
    ...
    Yn = { codeAt: Gn(!1), charAt: Gn(!0) }.charAt,
    Xn = function (t, e, n) {
        return e + (n ? Yn(t, e).length : 1)
    },
    tr = Z,
    er = ne,
    nr = D,
    ...
    return (
        ...
        (function (t, e) {
            ...
            var r,
                ...
                o = !1
            try {
                for (n = n.call(t); !(a = (r = n.next()).done) && (u.push(r.value), !e || u.length !== e); a = !0);
            } catch (t) {
                ;(o = !0), (i = t)
            } finally {
                try {
...
function pr(t, e) {
    ...
    if (!n) {
        if (Array.isArray(t) || (n = lr(t)) || (e && t && 'number' == typeof t.length)) {
            n && (t = n)
            var r = 0,
                i = function () {}
            return {
...
jn('match', 1, function (t, e, n) {
    return [
        ...
        function (t) {
            ...
            var i = tr(t),
                u = String(this)
            if (!i.global) return ir(i, u)
            var a = i.unicode
            i.lastIndex = 0
            for (var o, s = [], l = 0; null !== (o = ir(i, u)); ) {
                var c = String(o[0])
                ;(s[l] = c), '' === c && (i.lastIndex = rr(u, er(i.lastIndex), a)), l++
            }
            return 0 === l ? null : s
        },
    ]
...
var dr = b,
    ...
    Er = D,
    xr = Xn,
    Ar = function (t, e, n, r, i, u) {
        var a = n + t.length,
            o = r.length,
            s = Dr
        return (
            void 0 !== i && ((i = dr(i)), (s = gr)),
            hr.call(u, s, function (u, s) {
                var l
                switch (s.charAt(0)) {
                    case '$':
                        return '$'
    ...
    return [
        ...
        function (t, r) {
            ...
            for (var f = []; ; ) {
                ...
                if (null === h) break
                if ((f.push(h), !p)) break
                '' === String(h[0]) && (s.lastIndex = xr(l, yr(s.lastIndex), d))
            }
            for (var g, D = '', m = 0, v = 0; v < f.length; v++) {
                h = f[v]
                for (var y = String(h[0]), k = wr(Cr(kr(h.index), l.length), 0), E = [], x = 1; x < h.length; x++)
...
var Fr = k,
    Sr = Z,
    Br = function (t) {
        if (!Fr(t) && null !== t) throw TypeError("Can't set " + String(t) + ' as a prototype')
        return t
    },
    Tr =
        ...
        ('__proto__' in {}
            ? (function () {
                  ...
                  return function (n, r) {
                      return Sr(n), Br(r), e ? t.call(n, r) : (n.__proto__ = r), n
                  }
              })()
            : void 0),
    _r = k,
    ...
    Or = function (t) {
        var e
        return Rr(t) && (void 0 !== (e = t[Lr]) ? !!e : 'RegExp' == Ir(t))
    },
    $r = Kt,
    Pr = U,
    Mr = u,
...
if (
    ...
    qr(
        ...
        !ui ||
            ai ||
            Gr(function () {
                return (ii[ti] = !1), ei(ri) != ri || ei(ii) == ii || '/a/i' != ei(ri, 'i')
            })
    )
) {
    for (
        var oi = function (t, e) {
                var n,
                    ...
                    i = Jr(t),
                    u = void 0 === e
                if (!r && i && t.constructor === oi && u) return t
                ui ? i && !u && (t = t.source) : t instanceof oi && (u && (e = Vr.call(t)), (t = t.source)),
                    ai && (n = !!e && e.indexOf('y') > -1) && (e = e.replace(/y/g, ''))
                var a = Zr(ui ? new ei(t, e) : ei(t, e), r ? this : ni, oi)
                ai && n && (Yr(a).sticky = !0)
                return a
            },
            si = function (t) {
    ...
    pi(
        ...
        function () {
            var t = di(this),
                e = String(t.source),
                n = t.flags
            return '/' + e + '/' + String(void 0 === n && t instanceof RegExp && !('flags' in gi) ? hi.call(t) : n)
        },
        { unsafe: !0 }
    )
var yi = function (t) {
    ...
    Fi = function (t, e) {
        var n,
            r = ki(t).constructor
        return void 0 === r || null == (n = ki(r)[xi]) ? e : Ei(n)
    },
    Si = Xn,
    Bi = ne,
    Ti = Zn,
                    ...
                    ? function (t, n) {
                          ...
                          for (
                              ...
                              !(
                                  ...
                                  u.length > 1 && u.index < r.length && Ri.apply(s, u.slice(1)),
                                  (o = u[0].length),
                                  (c = a),
                                  s.length >= i)
                              );
                          ...
                          return (
                              c === r.length ? (!o && p.test('')) || s.push('') : s.push(r.slice(c)),
                ...
                function (t, i) {
                    ...
                    var a = wi(t),
                        ...
                        c =
                            ...
                            (a.unicode ? 'u' : '') +
                            (zi ? 'g' : 'y'),
                        p = new s(zi ? '^(?:' + a.source + ')' : a, c),
                        d = void 0 === i ? 4294967295 : i >>> 0
                    if (0 === d) return []
                    if (0 === o.length) return null === Ti(p, o) ? [o] : []
                    for (var f = 0, h = 0, g = []; h < o.length; ) {
                        p.lastIndex = zi ? 0 : h
                        var D,
                            m = Ti(p, zi ? o.slice(h) : o)
                        if (null === m || (D = Ii(Bi(p.lastIndex + (zi ? h : 0)), o.length)) === f) h = Si(o, h, l)
                        else {
                            if ((g.push(o.slice(f, h)), g.length === d)) return g
                            for (var v = 1; v <= m.length - 1; v++) if ((g.push(m[v]), g.length === d)) return g
                            h = f = D
                        }
                    }
...
var Li = D,
    ...
    Mi = function (t) {
        return function (e) {
            var n = String(Li(e))
            return 1 & t && (n = n.replace($i, '')), 2 & t && (n = n.replace(Pi, '')), n
        }
    },
    ji = { start: Mi(1), end: Mi(2), trim: Mi(3) },
    Ni = i,
    Ui = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    qi = function (t) {
        return Ni(function () {
            return !!Ui[t]() || '​᠎' != '​᠎'[t]() || Ui[t].name !== t
        })
    },
    Zi = ji.trim
Ze(
    { target: 'String', proto: !0, forced: qi('trim') },
    {
        trim: function () {
            return Zi(this)
        },
...
var Hi = d,
    ...
    Qi = function (t, e) {
        ...
        return (
            Vi(t) &&
                ('function' != typeof (n = t.constructor) || (n !== Array && !Vi(n.prototype))
                    ? Ji(n) && null === (n = n[Ki]) && (n = void 0)
                    : (n = void 0)),
    ...
    hu = Math.min
uu(
    { target: 'Array', proto: !0, forced: !du },
    {
        splice: function (t, e) {
            var n,
                r,
            ...
            if (
                (0 === p
                    ...
                    : 1 === p
                    ? ((n = 0), (r = l - c))
                    : ((n = p - 2), (r = hu(fu(ou(e), 0), l - c))),
                l + n - r > 9007199254740991)
            )
                throw TypeError('Maximum allowed length exceeded')
            for (i = cu(s, r), u = 0; u < r; u++) (a = c + u) in s && pu(i, u, s[a])
            if (((i.length = r), n < r)) {
                for (u = c; u < l - r; u++) (o = u + n), (a = u + r) in s ? (s[o] = s[a]) : delete s[o]
                for (u = l; u > l - r + n; u--) delete s[u - 1]
            } else if (n > r)
                for (u = l - r; u > c; u--) (o = u + n - 1), (a = u + r - 1) in s ? (s[o] = s[a]) : delete s[o]
...
var gu = i,
    ...
    Eu = Du('join', ',')
mu(
    { target: 'Array', proto: !0, forced: ku || !Eu },
    {
        join: function (t) {
            return yu.call(vu(this), void 0 === t ? ',' : t)
        },
    }
)
var xu = yi,
    Au = function (t, e, n) {
        if ((xu(t), void 0 === e)) return t
        switch (n) {
            case 0:
                return function () {
                    return t.call(e)
    ...
    _u = Tu.map
Ze(
    { target: 'Array', proto: !0, forced: !iu('map') },
    {
        map: function (t) {
            return _u(this, t, arguments.length > 1 ? arguments[1] : void 0)
        },
    }
)
var zu = Ze,
...
zu(
    { target: 'Array', proto: !0, forced: !ju },
    {
        slice: function (t, e) {
            ...
            if (
                Iu(u) &&
                ('function' != typeof (n = u.constructor) || (n !== Array && !Iu(n.prototype))
                    ? Ru(n) && null === (n = n[Nu]) && (n = void 0)
                    : (n = void 0),
                n === Array || void 0 === n)
            )
                return Uu.call(u, o, s)
            for (r = new (void 0 === n ? Array : n)(qu(s - o, 0)), i = 0; o < s; o++, i++) o in u && Pu(r, i, u[o])
            return (r.length = i), r
        },
    }
)
var Zu = Ze,
    ...
    Ju = Wu
        ...
        : ''.trimStart
Zu({ target: 'String', proto: !0, forced: Wu }, { trimStart: Ju, trimLeft: Ju })
var Vu = Ze,
    Ku = ji.end,
    Qu = qi('trimEnd'),
    Gu = Qu
        ...
        : ''.trimEnd
Vu({ target: 'String', proto: !0, forced: Qu }, { trimEnd: Gu, trimRight: Gu })
var Yu = Tu.filter
Ze(
    { target: 'Array', proto: !0, forced: !iu('filter') },
    {
        filter: function (t) {
...
var Xu = D,
    ...
    na = function (t, e, n, r) {
        var i = String(Xu(t)),
            u = '<' + e
        return '' !== n && (u += ' ' + n + '="' + String(r).replace(ta, '&quot;') + '"'), u + '>' + i + '</' + e + '>'
    }
Ze(
    {
        target: 'String',
    ...
    {
        link: function (t) {
            return na(this, 'a', 'href', t)
        },
    }
)
var ra = {}
ra[Fn('toStringTag')] = 'z'
var ia = '[object z]' === String(ra),
    ua = ia,
    aa = d,
    oa = Fn('toStringTag'),
    sa =
    ...
    la = ua
        ...
        : function (t) {
              ...
              return void 0 === t
                  ...
                  : sa
                  ? aa(e)
                  : 'Object' == (r = aa(e)) && 'function' == typeof e.callee
                  ? 'Arguments'
                  : r
          },
    ca = ia
    ...
    da = X.exports,
    fa = ca
pa || da(Object.prototype, 'toString', fa, { unsafe: !0 })
var ha = Tu.forEach,
    ga = n,
    Da = {
        CSSRuleList: 0,
...
var Fa,
    ...
    _a = u
        ...
        : function (t, e) {
              Ba(t)
              for (var n, r = Ta(e), i = r.length, u = 0; i > u; ) Sa.f(t, (n = r[u++]), e[n])
              return t
          },
    za = Kt('document', 'documentElement'),
    Ra = Z,
    Ia = _a,
    La = me,
    Oa = At,
    ...
    Ua = function () {
        ...
        Ua = Fa
            ...
            : (((e = Pa('iframe')).style.display = 'none'),
              $a.appendChild(e),
              (e.src = String('javascript:')),
              (t = e.contentWindow.document).open(),
              t.write(Na('document.F=Object')),
              t.close(),
              t.F)
        for (var n = La.length; n--; ) delete Ua.prototype[La[n]]
        return Ua()
    }
Oa[Ma] = !0
var qa =
        ...
        function (t, e) {
            var n
            return (
                null !== t ? ((ja.prototype = Ra(t)), (n = new ja()), (ja.prototype = null), (n[Ma] = t)) : (n = Ua()),
                void 0 === e ? n : Ia(n, e)
            )
        },
    Za = U,
    Ha = Fn('unscopables'),
    Wa = Array.prototype
null == Wa[Ha] && Za.f(Wa, Ha, { configurable: !0, value: qa(null) })
var Ja = pe.includes,
    Va = function (t) {
        Wa[Ha][t] = !0
    }
...
var Ka = Or,
    Qa = Fn('match'),
    Ga = function (t) {
        if (Ka(t)) throw TypeError("The method doesn't accept regular expressions")
        return t
    },
    Ya = D
Ze(
    ...
    {
        includes: function (t) {
            return !!~String(Ya(this)).indexOf(Ga(t), arguments.length > 1 ? arguments[1] : void 0)
        },
    }
)
var Xa = Ze,
    ...
    { target: 'Array', proto: !0, forced: !co || !po },
    {
        concat: function (t) {
            ...
            for (e = -1, r = arguments.length; e < r; e++)
                if (fo((u = -1 === e ? a : arguments[e]))) {
                    if (s + (i = io(u.length)) > 9007199254740991) throw TypeError('Maximum allowed index exceeded')
                    for (n = 0; n < i; n++, s++) n in u && uo(o, s, u[n])
                } else {
...
function Fo(t, e) {
    if (e) {
        if (Eo.test(t)) return t.replace(xo, Co)
    } else if (Ao.test(t)) return t.replace(bo, Co)
    return t
}
var So = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi
function Bo(t) {
    return t.replace(So, function (t, e) {
...
function _o(t, e) {
    ...
    var n = {
        replace: function (e, r) {
            return (r = (r = r.source || r).replace(To, '$1')), (t = t.replace(e, r)), n
        },
        getRegex: function () {
...
function Io(t, e, n) {
    if (t) {
        var r
        try {
            r = decodeURIComponent(Bo(n)).replace(zo, '').toLowerCase()
        } catch (t) {
            return null
        }
    ...
    e &&
        !Ro.test(n) &&
        (n = (function (t, e) {
            Lo[' ' + t] || (Oo.test(t) ? (Lo[' ' + t] = t + '/') : (Lo[' ' + t] = Uo(t, '/', !0)))
            var n = -1 === (t = Lo[' ' + t]).indexOf(':')
...
function Ho(t, e, n, r) {
    ...
    if ('!' !== t[0].charAt(0)) {
        r.state.inLink = !0
        var o = { type: 'link', raw: n, href: i, title: u, text: a, tokens: r.inlineTokens(a, []) }
        return (r.state.inLink = !1), o
    }
    return { type: 'image', raw: n, href: i, title: u, text: Fo(a) }
}
var Wo = (function () {
        function t(e) {
            ur(this, t), (this.options = e || ko)
        }
        return (
            or(t, [
                {
                    ...
                    value: function (t) {
                        ...
                        if (e) {
                            ...
                            return {
                                ...
                                text: this.options.pedantic ? n : Uo(n, '\n'),
                            }
                        }
                    },
                },
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        if (e) {
                            ...
                            for (
                                var m = new RegExp('^( {0,3}'.concat(h, ')((?: [^\\n]*)?(?:\\n|$))'));
                                t && ((f = !1), (e = m.exec(t))) && !this.rules.block.hr.test(t);
                                ...
                                if (
                                    ...
                                    !l &&
                                        /^ *$/.test(c) &&
                                        ((n += c + '\n'), (t = t.substring(c.length + 1)), (f = !0)),
                                    !f)
                                )
                                    for (
                                        var v = new RegExp(
                                            '^ {0,'.concat(Math.min(3, u - 1), '}(?:[*+-]|\\d{1,9}[.)])')
                                        );
                                        t &&
                                        ((l = p = t.split('\n', 1)[0]),
                            ...
                            for (a = 0; a < y; a++) {
                                ;(this.lexer.state.top = !1),
                                    (D.items[a].tokens = this.lexer.blockTokens(D.items[a].text, []))
                                ...
                                !D.loose && k.length && E && ((D.loose = !0), (D.items[a].loose = !0))
                            }
                            return D
                        }
                    },
                        ...
                        if (e) {
                            ...
                            return (
                                this.options.sanitize &&
                                    ((n.type = 'paragraph'),
                                    (n.text = this.options.sanitizer ? this.options.sanitizer(e[0]) : Fo(e[0])),
                                    (n.tokens = []),
                        ...
                        if (e) {
                            ...
                            if (n.header.length === n.align.length) {
                                ...
                                for (o = n.rows.length, r = 0; r < o; r++)
                                    n.rows[r] = No(n.rows[r], n.header.length).map(function (t) {
                                        return { text: t }
                                    })
                                ...
                                for (o = n.rows.length, i = 0; i < o; i++)
                                    for (a = n.rows[i], u = 0; u < a.length; u++)
                                        (a[u].tokens = []), this.lexer.inlineTokens(a[u].text, a[u].tokens)
                                return n
                            }
                        }
                    },
                        ...
                        if (e) {
                            ...
                            if (!this.options.pedantic && /^</.test(n)) {
                                ...
                                if (i > -1) {
                                    ...
                                    ;(e[2] = e[2].substring(0, i)), (e[0] = e[0].substring(0, u).trim()), (e[3] = '')
                                }
                            }
                            var a = e[2],
                                o = ''
                            ...
                            return (
                                (a = a.trim()),
                                /^</.test(a) &&
                                    (a = this.options.pedantic && !/>$/.test(n) ? a.slice(1) : a.slice(1, -1)),
                                Ho(
                                    e,
                                    {
                    ...
                    value: function (t, e) {
                        ...
                        if (
                            ...
                            if (!i || (i && ('' === n || this.rules.inline.punctuation.exec(n)))) {
                                ...
                                for (c.lastIndex = 0, e = e.slice(-1 * t.length + o); null != (r = c.exec(e)); )
                                    if ((u = r[1] || r[2] || r[3] || r[4] || r[5] || r[6]))
                                        if (((a = u.length), r[3] || r[4])) s += a
                                        else if (!((r[5] || r[6]) && o % 3) || (o + a) % 3) {
                                            if (!((s -= a) > 0)) {
                                                if (((a = Math.min(a, a + s + l)), Math.min(o, a) % 2)) {
                    ...
                    value: function (t, e) {
                        ...
                        if (i)
                            return (
                                (r =
                                    '@' === i[2]
                                        ? 'mailto:' + (n = Fo(this.options.mangle ? e(i[1]) : i[1]))
                                        : (n = Fo(i[1]))),
                                {
                                    type: 'link',
                                    raw: i[0],
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        ...
                        if ((n = this.rules.inline.url.exec(t))) {
                            var r, i
                            if ('@' === n[2]) i = 'mailto:' + (r = Fo(this.options.mangle ? e(n[0]) : n[0]))
                            else {
                                var u
                                do {
                                    ;(u = n[0]), (n[0] = this.rules.inline._backpedal.exec(n[0])[0])
                                } while (u !== n[0])
                                ;(r = Fo(n[0])), (i = 'www.' === n[1] ? 'http://' + r : r)
                            }
                            return {
                                type: 'link',
                                raw: n[0],
                                ...
                                (n = this.lexer.state.inRawBlock
                                    ? this.options.sanitize
                                        ? this.options.sanitizer
                                            ...
                                            : Fo(r[0])
                                        : r[0]
                                    : Fo(this.options.smartypants ? e(r[0]) : r[0])),
...
;(Jo.def = _o(Jo.def).replace('label', Jo._label).replace('title', Jo._title).getRegex()),
    (Jo.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (Jo.listItemStart = _o(/^( *)(bull) */)
        .replace('bull', Jo.bullet)
        .getRegex()),
    (Jo.list = _o(Jo.list)
        .replace(/bull/g, Jo.bullet)
        .replace('hr', '\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))')
        .replace('def', '\\n+(?=' + Jo.def.source + ')')
        .getRegex()),
    (Jo._tag =
    ...
    (Jo._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/),
    (Jo.html = _o(Jo.html, 'i')
        .replace('comment', Jo._comment)
        .replace('tag', Jo._tag)
        .replace('attribute', / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/)
        .getRegex()),
    (Jo.paragraph = _o(Jo._paragraph)
        .replace('hr', Jo.hr)
        ...
        .replace('tag', Jo._tag)
        .getRegex()),
    (Jo.blockquote = _o(Jo.blockquote).replace('paragraph', Jo.paragraph).getRegex()),
    (Jo.normal = jo({}, Jo)),
    (Jo.gfm = jo({}, Jo.normal, {
        table: '^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)',
    })),
    (Jo.gfm.table = _o(Jo.gfm.table)
        .replace('hr', Jo.hr)
        .replace('heading', ' {0,3}#{1,6} ')
        .replace('blockquote', ' {0,3}>')
        .replace('code', ' {4}[^\\n]')
        ...
        .replace('tag', Jo._tag)
        .getRegex()),
    (Jo.gfm.paragraph = _o(Jo._paragraph)
        .replace('hr', Jo.hr)
        .replace('heading', ' {0,3}#{1,6} ')
        .replace('|lheading', '')
        .replace('table', Jo.gfm.table)
        .replace('blockquote', ' {0,3}>')
        .replace('fences', ' {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n')
        .replace('list', ' {0,3}(?:[*+-]|1[.)]) ')
        .replace('html', '</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)')
    ...
    (Jo.pedantic = jo({}, Jo.normal, {
        ...
        heading: /^(#{1,6})(.*)(?:\n+|$)/,
        fences: Mo,
        paragraph: _o(Jo.normal._paragraph)
            .replace('hr', Jo.hr)
            .replace('heading', ' *#{1,6} *[^\n]')
            .replace('lheading', Jo.lheading)
            .replace('blockquote', ' {0,3}>')
            .replace('|fences', '')
            .replace('|list', '')
            .replace('|html', '')
...
;(Vo._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
    (Vo.punctuation = _o(Vo.punctuation)
        .replace(/punctuation/g, Vo._punctuation)
        .getRegex()),
    (Vo.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (Vo.escapedEmSt = /\\\*|\\_/g),
    (Vo._comment = _o(Jo._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
    (Vo.emStrong.lDelim = _o(Vo.emStrong.lDelim).replace(/punct/g, Vo._punctuation).getRegex()),
    (Vo.emStrong.rDelimAst = _o(Vo.emStrong.rDelimAst, 'g').replace(/punct/g, Vo._punctuation).getRegex()),
    (Vo.emStrong.rDelimUnd = _o(Vo.emStrong.rDelimUnd, 'g').replace(/punct/g, Vo._punctuation).getRegex()),
    (Vo._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (Vo._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (Vo._email =
        /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (Vo.autolink = _o(Vo.autolink).replace('scheme', Vo._scheme).replace('email', Vo._email).getRegex()),
    (Vo._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (Vo.tag = _o(Vo.tag).replace('comment', Vo._comment).replace('attribute', Vo._attribute).getRegex()),
    (Vo._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (Vo._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (Vo._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (Vo.link = _o(Vo.link)
        .replace('label', Vo._label)
        .replace('href', Vo._href)
        .replace('title', Vo._title)
        .getRegex()),
    (Vo.reflink = _o(Vo.reflink).replace('label', Vo._label).replace('ref', Jo._label).getRegex()),
    (Vo.nolink = _o(Vo.nolink).replace('ref', Jo._label).getRegex()),
    (Vo.reflinkSearch = _o(Vo.reflinkSearch, 'g')
        .replace('reflink', Vo.reflink)
        .replace('nolink', Vo.nolink)
        .getRegex()),
    (Vo.normal = jo({}, Vo)),
    (Vo.pedantic = jo({}, Vo.normal, {
        strong: {
            start: /^__|\*\*/,
    ...
    (Vo.gfm = jo({}, Vo.normal, {
        escape: _o(Vo.escape).replace('])', '~|])').getRegex(),
    ...
    (Vo.gfm.url = _o(Vo.gfm.url, 'i').replace('email', Vo.gfm._extended_email).getRegex()),
    (Vo.breaks = jo({}, Vo.gfm, {
        br: _o(Vo.br).replace('{2,}', '*').getRegex(),
        text: _o(Vo.gfm.text)
            .replace('\\b_', '\\b_| {2,}\\n')
            .replace(/\{2,\}/g, '*')
            .getRegex(),
...
var Go = (function () {
        function t(e) {
            ur(this, t),
                ...
                (this.options = e || ko),
                (this.options.tokenizer = this.options.tokenizer || new Wo()),
                (this.tokenizer = this.options.tokenizer),
                (this.tokenizer.options = this.options),
                (this.tokenizer.lexer = this),
                (this.inlineQueue = []),
                (this.state = { inLink: !1, inRawBlock: !1, top: !0 })
            var n = { block: Jo.normal, inline: Vo.normal }
            this.options.pedantic
                ? ((n.block = Jo.pedantic), (n.inline = Vo.pedantic))
                : this.options.gfm &&
                  ((n.block = Jo.gfm), this.options.breaks ? (n.inline = Vo.breaks) : (n.inline = Vo.gfm)),
                            ...
                            for (this.options.pedantic && (t = t.replace(/^ +$/gm, '')); t; )
                                if (
                                    ...
                                    if ((e = this.tokenizer.space(t)))
                                        ...
                                        (t = t.substring(e.raw.length)),
                                            !(n = a[a.length - 1]) || ('paragraph' !== n.type && 'text' !== n.type)
                                                ? a.push(e)
                                                : ((n.raw += '\n' + e.raw),
                                                  (n.text += '\n' + e.text),
                                    ...
                                    else if ((e = this.tokenizer.list(t))) (t = t.substring(e.raw.length)), a.push(e)
                                        ...
                                        this.options.extensions &&
                                            ...
                                            (function () {
                                                ...
                                                u.options.extensions.startBlock.forEach(function (t) {
                                                    'number' == typeof (i = t.call({ lexer: this }, n)) &&
                                                        i >= 0 &&
                                                        (e = Math.min(e, i))
                                                }),
                        ...
                        value: function (t) {
                            ...
                            for (; t; )
                                if (
                                    ...
                                    if ((e = this.tokenizer.escape(t))) (t = t.substring(e.raw.length)), s.push(e)
                                    else if ((e = this.tokenizer.tag(t)))
                                        (t = t.substring(e.raw.length)),
                                            (n = s[s.length - 1]) && 'text' === e.type && 'text' === n.type
                                                ? ((n.raw += e.raw), (n.text += e.text))
                                                : s.push(e)
                                    else if ((e = this.tokenizer.link(t))) (t = t.substring(e.raw.length)), s.push(e)
                                        ...
                                        (t = t.substring(e.raw.length)), s.push(e)
                                    else if ((e = this.tokenizer.br(t))) (t = t.substring(e.raw.length)), s.push(e)
                                    else if ((e = this.tokenizer.del(t))) (t = t.substring(e.raw.length)), s.push(e)
                                    else if ((e = this.tokenizer.autolink(t, Qo)))
                                        (t = t.substring(e.raw.length)), s.push(e)
                                    else if (this.state.inLink || !(e = this.tokenizer.url(t, Qo))) {
                                        if (
                                            ((r = t),
                                            this.options.extensions &&
                                            ...
                                            (e = this.tokenizer.inlineText(r, Ko)))
                                        )
                                            (t = t.substring(e.raw.length)),
        ...
        return (
            or(t, [
                ...
                },
                {
                    key: 'link',
                    value: function (t, e, n) {
                        if (null === (t = Io(this.options.sanitize, this.options.baseUrl, t))) return n
                        var r = '<a href="' + Fo(t) + '"'
                            ...
                            for (e = 0; e < x; e++)
                                if (
                                    ...
                                    !(
                                        ...
                                        (!1 ===
                                            (y = this.options.extensions.renderers[c.type].call({ parser: this }, c)) &&
                                            [
                                                'space',
                                                'hr',
                                                'heading',
                                    ...
                                    switch (c.type) {
                                        ...
                                        case 'heading':
                                            E += this.renderer.heading(
                                                ...
                                                c.depth,
                                                Bo(this.parseInline(c.tokens, this.textRenderer)),
                                                this.slugger
                                            )
                                            continue
                                        case 'code':
                                            ...
                                            continue
                                        case 'table':
                                            for (s = '', o = '', i = c.header.length, n = 0; n < i; n++)
                                                o += this.renderer.tablecell(this.parseInline(c.header[n].tokens), {
                                                    header: !0,
                                                    align: c.align[n],
                                                })
                                            for (
                                                s += this.renderer.tablerow(o), l = '', i = c.rows.length, n = 0;
                                                n < i;
                                                n++
                                            ) {
                                                for (o = '', u = (a = c.rows[n]).length, r = 0; r < u; r++)
                                                    o += this.renderer.tablecell(this.parseInline(a[r].tokens), {
                                                        header: !1,
                                                        align: c.align[r],
                                                    })
                                            ...
                                            continue
                                        case 'blockquote':
                                            ;(l = this.parse(c.tokens)), (E += this.renderer.blockquote(l))
                                            continue
                                        case 'list':
                                            for (
                                                p = c.ordered,
                                        ...
                                        case 'text':
                                            for (
                                                ...
                                                l += '\n' + ((c = t[++e]).tokens ? this.parseInline(c.tokens) : c.text)
                                            E += k ? this.renderer.paragraph(l) : l
                                            continue
                                        default:
                                            var A = 'Token with "' + c.type + '" type was not found.'
...
function ns(t, e, n) {
    ...
    if (('function' == typeof e && ((n = e), (e = null)), qo((e = jo({}, ns.defaults, e || {}))), n)) {
        var r,
            i = e.highlight
        try {
            r = Go.lex(t, e)
        ...
        var u = function (t) {
            ...
            if (!t)
                try {
                    e.walkTokens && ns.walkTokens(r, e.walkTokens), (u = es.parse(r, e))
                } catch (e) {
                    t = e
                }
        ...
        var a = 0
        return (
            ns.walkTokens(r, function (t) {
                'code' === t.type &&
                    (a++,
                    setTimeout(function () {
                        i(t.text, t.lang, function (e, n) {
                            if (e) return u(e)
                            null != n && n !== t.text && ((t.text = n), (t.escaped = !0)), 0 === --a && u()
                        })
                    }, 0))
            }),
            void (0 === a && u())
    ...
    try {
        var o = Go.lex(t, e)
        return e.walkTokens && ns.walkTokens(o, e.walkTokens), es.parse(o, e)
    } catch (t) {
        if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
            return '<p>An error occurred:</p><pre>' + Fo(t.message + '', !0) + '</pre>'
        throw t
    }
}
;(ns.options = ns.setOptions =
    function (t) {
        var e
        return jo(ns.defaults, t), (e = ns.defaults), (ko = e), ns
    }),
    (ns.getDefaults = yo),
    (ns.defaults = ko),
    (ns.use = function () {
        ...
        var r,
            i = jo.apply(void 0, [{}].concat(e)),
            u = ns.defaults.extensions || { renderers: {}, childTokens: {} }
        e.forEach(function (t) {
            if (
                (t.extensions &&
                    ...
                    t.extensions.forEach(function (t) {
                        ...
                        if (t.tokenizer) {
                            ...
                            u[t.level] ? u[t.level].unshift(t.tokenizer) : (u[t.level] = [t.tokenizer]),
                                t.start &&
                                    ('block' === t.level
                                        ? u.startBlock
                                        ...
                                        : 'inline' === t.level &&
                                          (u.startInline ? u.startInline.push(t.start) : (u.startInline = [t.start])))
                        }
                        t.childTokens && (u.childTokens[t.name] = t.childTokens)
                    })),
                t.renderer &&
                    (function () {
                        var e = ns.defaults.renderer || new Yo(),
                            n = function (n) {
                                var r = e[n]
                                e[n] = function () {
                ...
                t.tokenizer &&
                    (function () {
                        var e = ns.defaults.tokenizer || new Wo(),
                            n = function (n) {
                                var r = e[n]
                                e[n] = function () {
                                    for (var i = arguments.length, u = new Array(i), a = 0; a < i; a++)
                ...
                var e = ns.defaults.walkTokens
                i.walkTokens = function (n) {
                    t.walkTokens.call(this, n), e && e.call(this, n)
                }
            }
            r && (i.extensions = u), ns.setOptions(i)
        })
    }),
    (ns.walkTokens = function (t, e) {
        var n,
            r = pr(t)
        try {
            var i = function () {
                var t = n.value
                switch ((e.call(ns, t), t.type)) {
                    case 'table':
                        var r,
                            i = pr(t.header)
                        try {
                        ...
                        break
                    case 'list':
                        ns.walkTokens(t.items, e)
                        break
                    default:
                        ns.defaults.extensions &&
                        ns.defaults.extensions.childTokens &&
                        ns.defaults.extensions.childTokens[t.type]
                            ? ns.defaults.extensions.childTokens[t.type].forEach(function (n) {
                                  ns.walkTokens(t[n], e)
                              })
                            : t.tokens && ns.walkTokens(t.tokens, e)
                }
            }
    ...
    (ns.parseInline = function (t, e) {
        ...
        qo((e = jo({}, ns.defaults, e || {})))
        try {
            var n = Go.lexInline(t, e)
            return e.walkTokens && ns.walkTokens(n, e.walkTokens), es.parseInline(n, e)
        } catch (t) {
            if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
                return '<p>An error occurred:</p><pre>' + Fo(t.message + '', !0) + '</pre>'
            throw t
...
export default function () {
    ...
    function r() {
        if (n && !n.closed) n.focus()
            ...
            if (
                (((n = window.open('about:blank', 'reveal.js - Notes', 'width=1100,height=700')).marked = ns),
                n.document.write(
            ...
            ;(r = e.getConfig().url),
                ...
                (t = setInterval(function () {
                    n.postMessage(
                        JSON.stringify({ namespace: 'reveal-notes', type: 'connect', state: e.getState(), url: i }),
                        '*'
                    )
                }, 500)),
    ...
    function i(t) {
        ...
        if (
            (r.hasAttribute('data-notes') && ((a.notes = r.getAttribute('data-notes')), (a.whitespace = 'pre-wrap')), u)
        ) {
            var o = u.querySelector('aside.notes')
            o
                ? (i = o)
                : u.hasAttribute('data-notes') &&
                  ((a.notes = u.getAttribute('data-notes')), (a.whitespace = 'pre-wrap'), (i = null))
        }
        i && ((a.notes = i.innerHTML), (a.markdown = 'string' == typeof i.getAttribute('data-markdown'))),
    ...
    function u(r) {
        ...
        l && 'reveal-notes' === l.namespace && 'connected' === l.type
            ...
            : l &&
              ...
              (o = l.callId),
              (s = e[i].apply(e, u)),
              n.postMessage(JSON.stringify({ namespace: 'reveal-notes', type: 'return', result: s, callId: o }), '*'))
    }
    function a() {
        e.on('slidechanged', i),
                        ...
                        : window.addEventListener('message', function (t) {
                              if (!n && 'string' == typeof t.data) {
                                  ...
                                  e &&
                                      ...
                                      n && !n.closed
                                          ? n.focus()
                                          : ((n = r), window.addEventListener('message', u), a()))
                              }
                              var r
                          }),
