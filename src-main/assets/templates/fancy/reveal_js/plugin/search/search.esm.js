...
var _e,
    ...
    Ie = Math.random(),
    Ce = function (e) {
        return 'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++Pe + Ie).toString(36)
    },
    Ne = o,
    Ae = o,
    ke = function (e) {
    ...
    $e = function (e, t) {
        return arguments.length < 2 ? ke(Ne[e]) || ke(Ae[e]) : (Ne[e] && Ne[e][t]) || (Ae[e] && Ae[e][t])
    },
...
De
    ...
    : Le && (!(_e = Le.match(/Edge\/(\d+)/)) || _e[1] >= 74) && (_e = Le.match(/Chrome\/(\d+)/)) && (je = _e[1])
var Fe = je && +je,
    ze = t,
    Ke =
...
var kt = {
        ...
        getterFor: function (e) {
            return function (t) {
                var n
                if (!St(t) || (n = pt(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
                return n
            }
        },
    },
...
;(ut.exports = function (e, t, n, r) {
    ...
    'function' == typeof n &&
        ...
        e !== $t ? (i ? !a && e[t] && (c = !0) : delete e[t], c ? (e[t] = n) : Lt(e, t, n)) : c ? (e[t] = n) : Ut(t, n)
...
if (
    ...
    Xt(
        ...
        !pn ||
            gn ||
            rn(function () {
                return (sn[an] = !1), un(fn) != fn || un(sn) == sn || '/a/i' != un(fn, 'i')
            })
    )
) {
    for (
        var dn = function (e, t) {
                ...
                pn ? o && !i && (e = e.source) : e instanceof dn && (i && (t = en.call(e)), (e = e.source)),
    ...
    rr(
        ...
        function () {
            var e = or(this),
                t = String(e.source),
                n = e.flags
            return '/' + t + '/' + String(void 0 === n && e instanceof RegExp && !('flags' in ar) ? cr.call(e) : n)
        },
        { unsafe: !0 }
    )
var sr = ut.exports,
    ...
    kr = function (e, t, n, r) {
        ...
        if (!i || !c || ('replace' === e && (!xr || !br || mr)) || ('split' === e && !Sr)) {
            var a = /./[o],
                u = n(
                    o,
                    ''[e],
                    ...
                    { REPLACE_KEEPS_$0: br, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: mr }
                ),
                l = u[0],
                f = u[1]
    ...
    zr = function (e, t) {
        ...
        if ('RegExp' !== Nr(e)) throw TypeError('RegExp#exec called on incompatible receiver')
        return Ar.call(e, t)
    },
    Kr = Math.max,
    Br = Math.min
    ...
    return [
        ...
        function (e, r) {
            ...
            for (var h, y = '', v = 0, x = 0; x < g.length; x++) {
                d = g[x]
                for (var b = String(d[0]), E = Kr(Br(Mr(d.index), l.length), 0), m = [], S = 1; S < d.length; S++)
                ...
                if (null != t && t && l && !i.test(t.nodeName)) {
                    ...
                    if (3 == t.nodeType)
                        if ((r = t.nodeValue) && (s = l.exec(r))) {
                            ...
                            h || f.push(g), a[s[0].toLowerCase()] || (a[s[0].toLowerCase()] = c[u++ % c.length])
            ...
            ;(e = n).registerKeyboardShortcut('CTRL + Shift + F', 'Search'),
                document.addEventListener(
                    ...
                    function (e) {
                        'F' == e.key &&
                            (e.ctrlKey || e.metaKey) &&
                            (e.preventDefault(), t || a(), 'inline' !== t.style.display ? u() : l())
                    },
                    !1
                )
        },
