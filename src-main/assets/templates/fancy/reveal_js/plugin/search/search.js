!(function (e, t) {
    ...
    Fe
        ...
        : Me && (!(je = Me.match(/Edge\/(\d+)/)) || je[1] >= 74) && (je = Me.match(/Chrome\/(\d+)/)) && (Pe = je[1])
    var ze = Pe && +Pe,
        Ke = t,
        Be =
    ...
    ;(lt.exports = function (e, t, n, r) {
        ...
        'function' == typeof n &&
            ...
            (o = Bt(n)).source || (o.source = Wt.join('string' == typeof t ? t : ''))),
            e !== Mt
                ? (i ? !a && e[t] && (c = !0) : delete e[t], c ? (e[t] = n) : Ut(e, t, n))
                : c
                ? (e[t] = n)
                : Ft(t, n)
    ...
    if (
        ...
        for (
            var yn = function (e, t) {
                    ...
                    gn ? o && !i && (e = e.source) : e instanceof yn && (i && (t = nn.call(e)), (e = e.source)),
    ...
    var gr = lt.exports,
        ...
        Mr = function (e, t, n, r) {
            ...
            if (!i || !c || ('replace' === e && (!Er || !Sr || Or)) || ('split' === e && !Rr)) {
                var a = /./[o],
                    u = n(
                        o,
                        ''[e],
                        ...
                        { REPLACE_KEEPS_$0: Sr, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Or }
                    ),
                    l = u[0],
                    f = u[1]
        ...
        return [
            ...
            function (e, r) {
                ...
                for (var h, y = '', v = 0, x = 0; x < d.length; x++) {
                    g = d[x]
                    for (var b = String(g[0]), m = Gr(Vr(Fr(g.index), l.length), 0), E = [], S = 1; S < g.length; S++)
