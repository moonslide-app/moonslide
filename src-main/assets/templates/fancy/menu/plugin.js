...
const Plugin = () => {
    ...
    function visibleOffset(el) {
        ...
        var offsetFromBottom =
            el.offsetParent.offsetHeight - (el.offsetTop - el.offsetParent.scrollTop + el.offsetHeight)
        ...
        if (isOpen()) {
            ...
            switch (event.keyCode) {
                ...
                case 68:
                    ...
                    var lastVisible =
                        itemsBelow.length > 0 && Math.abs(visibleOffset(itemsBelow[0])) < itemsBelow[0].clientHeight
                            ? itemsBelow[0]
