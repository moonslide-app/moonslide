...
var n = function (e) {
    ...
    g = function (e, t) {
        if (!v(e)) return e
        var n, i
        if (t && 'function' == typeof (n = e.toString) && !v((i = n.call(e)))) return i
    ...
    I = i['__core-js_shared__'] || k('__core-js_shared__', {}),
    P = Function.toString
...
var M,
    ...
    D = Math.random(),
    B = function (e) {
        return 'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++$ + D).toString(36)
    },
    q = H('keys'),
    U = {},
    G = i.WeakMap
...
var J = {
        ...
        getterFor: function (e) {
            return function (t) {
                var n
                if (!v(t) || (n = N(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
                return n
            }
        },
    },
    ...
    te = function (e, t) {
        return arguments.length < 2 ? ee(Q[e]) || ee(i[e]) : (Q[e] && Q[e][t]) || (i[e] && i[e][t])
    },
    ne = Math.ceil,
    ie = Math.floor,
    re = function (e) {
            ...
            function (e) {
                return (function (e, t) {
                    var n,
                        ...
                        r = 0,
                        a = []
                    for (n in i) !b(U, n) && b(i, n) && a.push(n)
                    for (; t.length > r; ) b(i, (n = t[r++])) && (~de(a, n) || a.push(n))
                    return a
                })(e, pe)
            },
    },
    ...
    ge = function (e, t) {
        for (var n = ve(t), i = O.f, r = L.f, a = 0; a < n.length; a++) {
            var o = n[a]
            b(e, o) || i(e, o, r(t, o))
        }
    },
    ...
    be = function (e, t) {
        var n = Ee[Se(e)]
        return n == we || (n != xe && ('function' == typeof t ? r(t) : !!t))
    },
    ...
    Ce = function (e, t) {
        var n,
            ...
            c = e.global,
            u = e.stat
        if ((n = c ? i : u ? i[l] || k(l, {}) : (i[l] || {}).prototype))
            for (r in t) {
                if (
                    ((o = t[r]),
                    (a = e.noTargetGet ? (s = Te(n, r)) && s.value : n[r]),
                    !Le(c ? r : l + (u ? '.' : '#') + r, e.forced) && void 0 !== a)
                ) {
                    if (typeof o == typeof a) continue
                    ge(o, a)
                }
                ;(e.sham || (a && a.sham)) && A(o, 'sham', !0), Z(n, r, o, e)
            }
    },
    Oe = function (e) {
    ...
    Me = H('wks'),
    Ne = i.Symbol,
    Re = Pe ? Ne : (Ne && Ne.withoutSetter) || B,
    je = function (e) {
        return b(Me, e) || (Ie && b(Ne, e) ? (Me[e] = Ne[e]) : (Me[e] = Re('Symbol.' + e))), Me[e]
    },
    _e = je('species'),
    Fe = function (e, t) {
        var n
    ...
    $e = { forEach: He(0), map: He(1), filter: He(2), some: He(3), every: He(4), find: He(5), findIndex: He(6) },
    De = function (e, t) {
        var n = [][e]
        return (
            !!n &&
    ...
    Ge = function (e, t) {
        ...
        return (qe[e] =
            ...
            !r(function () {
                if (i && !a) return !0
                var e = { length: -1 }
                i ? Be(e, 1, { enumerable: !0, get: Ue }) : (e[1] = 1), n.call(e, o, s)
            }))
    },
    Ve = $e.every,
    Ke = De('every'),
        ...
        Et || !xt || !wt
            ? function (e) {
                  ...
                  var t = m(this),
                      n = oe(t.length),
                      i = n - 1
                  for (arguments.length > 1 && (i = bt(i, re(arguments[1]))), i < 0 && (i = n + i); i >= 0; i--)
...
Ce(
    { target: 'Array', proto: !0, forced: !kt || !It },
    {
        slice: function (e, t) {
            ...
            for (i = new (void 0 === n ? Array : n)(Nt(l - s, 0)), r = 0; s < l; s++, r++) s in a && At(i, r, a[s])
            return (i.length = r), i
        },
    }
)
...
var Wt = he.f,
    ...
    Dt = function (e) {
        return $t && '[object Window]' == Ht.call(e)
            ? (function (e) {
                  try {
                      return Wt(e)
                  } catch (e) {
...
var Bt = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    ...
    Vt = function (e) {
        return function (t) {
            var n = String(h(t))
            return 1 & e && (n = n.replace(Ut, '')), 2 & e && (n = n.replace(Gt, '')), n
        }
    },
        ...
        return (
            ...
            o
                ? i
                    ...
                    : (a.lastIndex = 0)
                : un && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
            dn &&
                i &&
                i.length > 1 &&
                ln.call(i[0], n, function () {
    ...
    },
    {
        endsWith: function (e) {
            ...
            var n = arguments.length > 1 ? arguments[1] : void 0,
                i = oe(t.length),
                r = void 0 === n ? i : xn(oe(n), i),
                a = String(e)
            return En ? En.call(t, a, r) : t.slice(r - a.length, r) === a
        },
    }
)
var Ln = je('species'),
    ...
    return [
        ...
        function (e, i) {
            ...
            for (var h = []; ; ) {
                ...
                if (null === m) break
                if ((h.push(m), !d)) break
                '' === String(m[0]) && (c.lastIndex = Nn(u, oe(c.lastIndex), p))
            }
            for (var v, g = '', y = 0, b = 0; b < h.length; b++) {
                m = h[b]
                for (var S = String(m[0]), E = jn(_n(re(m.index), u.length), 0), x = [], w = 1; w < m.length; w++)
...
In('search', 1, function (e, t, n) {
    return [
        ...
        function (e) {
            ...
            $n(o, 0) || (r.lastIndex = 0)
            var s = Rn(r, a)
            return $n(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
        },
    ]
})
var Dn = je('species'),
                    ...
                    ? function (e, n) {
                          ...
                          for (
                              ...
                              !(
                                  ...
                                  a.length > 1 && a.index < i.length && Bn.apply(l, a.slice(1)),
                                  (s = a[0].length),
                                  (u = o),
                                  l.length >= r)
                              );
                          ...
                          return (
                              u === i.length ? (!s && f.test('')) || l.push('') : l.push(i.slice(u)),
                ...
                function (e, r) {
                    ...
                    var o = T(e),
                        ...
                        l = (function (e, t) {
                            var n,
                                i = T(e).constructor
                            return void 0 === i || null == (n = T(i)[Dn]) ? t : Oe(n)
                        })(o, RegExp),
                        c = o.unicode,
                        u =
                            (o.ignoreCase ? 'i' : '') +
                            ...
                            (o.unicode ? 'u' : '') +
                            (Un ? 'y' : 'g'),
                        f = new l(Un ? o : '^(?:' + o.source + ')', u),
                        d = void 0 === r ? 4294967295 : r >>> 0
                    if (0 === d) return []
                    if (0 === s.length) return null === Rn(f, s) ? [s] : []
                    for (var p = 0, h = 0, m = []; h < s.length; ) {
                        f.lastIndex = Un ? h : 0
                        var v,
                            g = Rn(f, Un ? s : s.slice(h))
                        if (null === g || (v = qn(oe(f.lastIndex + (Un ? 0 : h)), s.length)) === p) h = Nn(s, h, c)
                        else {
    ...
    },
    {
        startsWith: function (e) {
            ...
            var n = oe(Kn(arguments.length > 1 ? arguments[1] : void 0, t.length)),
                i = String(e)
            return Vn ? Vn.call(t, i, n) : t.slice(n, n + i.length) === i
        },
    }
)
var Xn,
    ...
    ti = function (e) {
        return function (t, n) {
            var i = arguments.length > 2,
                r = i ? ei.call(arguments, 2) : void 0
            return e(
                i
                    ? function () {
...
Ce(
    ...
    { setTimeout: ti(i.setTimeout), setInterval: ti(i.setInterval) }
)
...
export default function () {
        ...
        ;((i = e.menu || {}).path =
            ...
            (function () {
                ...
                if (document.querySelector('script[src$="menu.js"]')) {
                    ...
                    t && (e = t.src.slice(0, -7))
                } else e = import.meta.url.slice(0, import.meta.url.lastIndexOf('/') + 1)
                return e
            })() ||
            'plugin/menu/'),
            i.path.endsWith('/') || (i.path += '/'),
            void 0 === i.side && (i.side = 'left'),
            void 0 === i.numbers && (i.numbers = !1),
            'string' != typeof i.titleSelector && (i.titleSelector = 'h1, h2, h3, h4, h5'),
            void 0 === i.hideMissingTitles && (i.hideMissingTitles = !1),
            void 0 === i.useTextContentForMissingTitles && (i.useTextContentForMissingTitles = !1),
            void 0 === i.markers && (i.markers = !0),
            'string' != typeof i.themesPath && (i.themesPath = 'dist/theme/'),
            i.themesPath.endsWith('/') || (i.themesPath += '/'),
            O('link#theme') || (i.themes = !1),
            !0 === i.themes
                ? (i.themes = [
                      { name: 'Black', theme: i.themesPath + 'black.css' },
                      { name: 'White', theme: i.themesPath + 'white.css' },
                      { name: 'League', theme: i.themesPath + 'league.css' },
                      { name: 'Sky', theme: i.themesPath + 'sky.css' },
                      { name: 'Beige', theme: i.themesPath + 'beige.css' },
                      { name: 'Simple', theme: i.themesPath + 'simple.css' },
                      { name: 'Serif', theme: i.themesPath + 'serif.css' },
                      { name: 'Blood', theme: i.themesPath + 'blood.css' },
                      { name: 'Night', theme: i.themesPath + 'night.css' },
                      { name: 'Moon', theme: i.themesPath + 'moon.css' },
                      { name: 'Solarized', theme: i.themesPath + 'solarized.css' },
                  ])
                : Array.isArray(i.themes) || (i.themes = !1),
            void 0 === i.transitions && (i.transitions = !1),
            !0 === i.transitions
                ? (i.transitions = ['None', 'Fade', 'Slide', 'Convex', 'Concave', 'Zoom'])
                : !1 === i.transitions ||
                  (Array.isArray(i.transitions) &&
                      i.transitions.every(function (e) {
                  ...
                  (i.transitions = !1)),
            r && r <= 9 && (i.transitions = !1),
            void 0 === i.openButton && (i.openButton = !0),
            void 0 === i.openSlideNumber && (i.openSlideNumber = !1),
            void 0 === i.keyboard && (i.keyboard = !0),
            void 0 === i.sticky && (i.sticky = !1),
            void 0 === i.autoOpen && (i.autoOpen = !0),
            void 0 === i.delayInit && (i.delayInit = !1),
            void 0 === i.openOnInit && (i.openOnInit = !1)
    }
    var s = !0
    function l() {
        s = !1
    ...
    function h(e) {
        e.classList.add('selected'), f(e), i.sticky && i.autoOpen && E(e)
    }
    function m(e) {
        if (b())
            switch ((e.stopImmediatePropagation(), e.keyCode)) {
                ...
                case 68:
                    ...
                    var r = A('.active-menu-panel .slide-menu-items li').filter(function (e) {
                            return u(e) < 0
                        }),
                        a = r.length > 0 && Math.abs(u(r[0])) < r[0].clientHeight ? r[0] : n[n.length - 1]
                    a &&
    ...
    function v(e) {
        ;(e && e.preventDefault(), b()) ||
            ...
            O('.reveal').classList.add('has-' + i.effect + '-' + i.side),
    ...
    function g(e, t) {
        e && e.preventDefault(),
            (i.sticky && !t) ||
                ...
                O('.reveal').classList.remove('has-' + i.effect + '-' + i.side),
    ...
    function E(e, n) {
        var r = parseInt(e.getAttribute('data-slide-h')),
    ...
    function w() {
        ...
        A('li.slide-menu-item, li.slide-menu-item-vertical').forEach(function (t) {
            ...
            var n = parseInt(t.getAttribute('data-slide-h')),
                i = parseInt(t.getAttribute('data-slide-v'))
            n < e.indexh || (n === e.indexh && i < e.indexv)
                ? t.classList.add('past')
                : n === e.indexh && i === e.indexv
    ...
    function C() {
        if (!a) {
            var e = function (e, t, n, i, r, a) {
                ...
                r = function (e, r, a, o, s) {
                    function l(e, t) {
                        if ('' === e) return null
                        var n = t ? O(e, r) : O(e)
                        return n ? n.textContent : null
                    }
                    var c = r.getAttribute('data-menu-title') || l('.menu-title', r) || l(i.titleSelector, r)
                    if (
                        (!c &&
                            i.useTextContentForMissingTitles &&
            ...
            l.appendChild(c)
            var u = k('nav', { class: 'slide-menu slide-menu--' + i.side })
            'string' == typeof i.width &&
                (-1 != ['normal', 'wide', 'third', 'half', 'full'].indexOf(i.width)
                    ? u.classList.add('slide-menu--' + i.width)
                    : (u.classList.add('slide-menu--custom'), (u.style.width = i.width))),
                c.appendChild(u),
                L()
            ...
            O('.slide-menu').appendChild(d),
                ...
                i.custom &&
                    i.custom.forEach(function (t, n, i) {
                        e(t.title, 'Custom' + n, t.icon, null, S)
                    }),
                i.themes && e('Themes', 'Themes', 'fa-adjust', 'fas', S),
                i.transitions && e('Transitions', 'Transitions', 'fa-sticky-note', 'fas', S)
            ...
            if (
                ...
                d.appendChild(p),
                (function e() {
                    if (document.querySelector('section[data-markdown]:not([data-markdown-parsed])')) setTimeout(e, 100)
                    else {
                        ...
                        A('.slides > section').forEach(function (e, t) {
                            ...
                            if (a.length > 0)
                                a.forEach(function (e, a) {
                                    var o = r(0 === a ? 'slide-menu-item' : 'slide-menu-item-vertical', e, i, t, a)
                                    o && n.appendChild(o), i++
                                })
                            else {
                                var o = r('slide-menu-item', e, i, t)
                                o && n.appendChild(o), i++
                            }
                        }),
                ...
                i.custom.forEach(function (e, t, n) {
                    var i = k('div', { 'data-panel': 'Custom' + t, class: 'slide-menu-panel slide-menu-custom-panel' })
                    e.content
                        ? ((i.innerHTML = e.content), C(i))
                        : e.src &&
                          (function (e, t) {
            ...
            if (i.transitions) {
                ...
                P.appendChild(M),
                    i.transitions.forEach(function (e, t) {
                        var n = k(
                            'li',
                            { class: 'slide-menu-item', 'data-transition': e.toLowerCase(), 'data-item': '' + (t + 1) },
                            e
                        )
            ...
            if (i.openButton) {
                var N = k('div', { class: 'slide-menu-button' }),
                    R = k('a', { href: '#' })
                R.appendChild(k('i', { class: 'fas fa-bars' })),
                    N.appendChild(R),
                    O('.reveal').appendChild(N),
                    (N.onclick = v)
            }
            if (i.openSlideNumber) O('div.slide-number').onclick = v
        ...
        if (i.keyboard) {
            if (
                ...
                var j = n.keyboardCondition
                n.keyboardCondition = function (e) {
                    return j(e) && (!b() || 77 == e.keyCode)
                }
            } else
                n.keyboardCondition = function (e) {
    ...
    function P(e, t, n) {
        ...
        'script' === t
            ? (((i = document.createElement('script')).type = 'text/javascript'), (i.src = e))
            : 'stylesheet' === t && (((i = document.createElement('link')).rel = 'stylesheet'), (i.href = e))
        var a = function () {
    ...
    return {
        ...
        init: function (e) {
            o((n = (t = e).getConfig())),
                P(i.path + 'menu.css', 'stylesheet', function () {
                    void 0 === i.loadIcons || i.loadIcons
                        ? P(i.path + 'font-awesome/css/all.css', 'stylesheet', M)
                        : M()
                })
        },
        toggle: y,
