import { Columns, Play, Redo, RefreshCcw, Undo } from 'lucide-react'
    ...
    return (
        <div className="flex flex-row justify-between items-center space-b bg-secondary h-9 text-sm text-secondary-foreground draggable">
            <div className="flex flex-row w-[20%] min-w-min h-full items-center justify-start">
                ...
                <div className="flex flex-row flex-grow w-[20%] justify-start px-4 space-x-2">
            ...
            <div className="flex flex-row w-[60%] min-w-min h-full items-center justify-center px-4">Moonslide</div>
            <div className="flex flex-row w-[20%] min-w-min h-full items-center justify-end px-4 space-x-2">
